...
if PLATFORM == 'gcc':
    ...
    CFLAGS  = DEVICE + ' -DMC50_E907 -c -g -ffunction-sections -fdata-sections -Wall -Werror -mcmodel=medlow'
    AFLAGS  = ' -c' + DEVICE + ' -x assembler-with-cpp'
    LFLAGS  = DEVICE + ' -DMC50_E907 -nostartfiles -Wl,--no-whole-archive -T link.lds -lm -lc -lgcc -Wl,-gc-sections -Wl,-zmax-page-size=1024 -Wl,-Map=rtthread.map'
    CPATH   = ''
    LPATH   = ''
