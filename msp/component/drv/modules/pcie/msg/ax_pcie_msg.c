...
PCIE_API AX_S32 AX_PCIe_OpenMsgPort(AX_S32 s32PciTgtId, AX_S32 s32PciPort)
{
...
PCIE_API AX_S32 AX_PCIe_CloseMsgPort(AX_S32 s32PciTgtId, AX_S32 s32PciPort)
{
    AX_S32 s32Ret = AX_SUCCESS;
    AX_S32 s32MsgFd;
    AX_MSG_HANDLE_ATTR_T stAttr;
...
PCIE_API AX_S32 AX_PCIe_GetLocalId(AX_S32 *pPciLoacalId)
{
    AX_S32 s32Fd;
    AX_MSG_HANDLE_ATTR_T stAttr;
...
PCIE_API AX_S32 AX_PCIe_GetTargetId(AX_S32 *pPciTgtId, AX_S32 *pPciRmtCnt)
{
    AX_S32 s32Fd;
    AX_S32 s32Ret = AX_SUCCESS;
    AX_S32 i;
...
PCIE_API AX_S32 AX_PCIe_ShareMemInit(AX_S32 s32PciTgtId)
{
    AX_S32 s32Fd;
    AX_S32 s32Ret = AX_SUCCESS;
    AX_MSG_HANDLE_ATTR_T stAttr;
...
PCIE_API AX_S32 AX_PCIe_WriteMsg(AX_S32 s32PciTgtId, AX_S32 s32PciPort, AX_VOID *pPciMsg, AX_S32 s32Len)
{
    AX_S32 s32Ret = AX_SUCCESS;
    AX_S32 s32MsgFd;
...
PCIE_API AX_S32 AX_PCIe_ReadMsg(AX_S32 s32PciTgtId, AX_S32 s32PciPort, AX_VOID *pPciMsg, AX_S32 s32Len, AX_S32 nTimeOut)
{
    ...
    if (!(MsgEvent.revents & (POLLIN | POLLRDNORM))) {
        if (MsgEvent.revents & POLLNVAL) {
            return AX_PCIE_POLL_NVAL;
        }

        if (MsgEvent.revents & POLLHUP) {
            return AX_PCIE_POLL_HUP;
        }

        AX_PCIE_ERR("PCIe read msg poll event error: %x\n", MsgEvent.revents);
        return AX_FAILURE;
    }
...
PCIE_API AX_S32 AX_PCIe_Reset(AX_S32 s32PciTgtId)
{
    AX_S32 s32Fd;
    AX_S32 s32Ret = AX_SUCCESS;
    AX_MSG_HANDLE_ATTR_T stAttr;
