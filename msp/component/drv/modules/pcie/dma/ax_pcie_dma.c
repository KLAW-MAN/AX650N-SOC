...
#ifdef AXCL_HOST
#include "../log/logger_warpper.h"
#define PCIE_API __attribute((visibility("default")))
#else
#define PCIE_API
#endif
...
#define PCIE_DMA_LLP_TASK     _IOW(PCIE_BASE, 5, PCIE_DMA_TASK_T)

#define NOOP(...)

#ifdef AXCL_HOST
#define AX_PCIE_DEBUG axcl_pcie_debug_log
#define AX_PCIE_INFO  axcl_pcie_info_log
#define AX_PCIE_ERR   axcl_pcie_err_log
#define AX_PCIE_WARN  axcl_pcie_warn_log
#else
...
PCIE_API AX_S32 AX_PCIe_SendDmaMsg(AX_S32 Target, AX_S32 Port, DMA_MSG_TYPE_T DMA_MSG_Type, PCIE_DMA_MSG_DATA_T Data);
PCIE_API AX_S32 AX_PCIe_RecvDmaMsg(AX_S32 Target, AX_S32 Port, PCIE_DMA_MSG_T *PCIeDmaMsg, AX_S32 nTimeOut);
 ...
 */
PCIE_API AX_S32 AX_PCIe_InitRcMsg(AX_U32 PortCnt, AX_U32 PortBaseNum)
{
    AX_S32 Ret = 0;
    AX_S32 i, j;
    AX_S32 RmtChipId;
 ...
 * @return: success = 0, failure = -1
 */
PCIE_API AX_S32 AX_PCIe_InitEpMsg(AX_U32 PortCnt, AX_U32 PortBaseNum)
{
    AX_S32 Ret;
    AX_S32 i;
    AX_S32 PciLocalId;
 ...
 */
PCIE_API AX_S32 AX_PCIe_GetPcieDevIdArray(AX_S32 **PcieDevId)
{
 ...
 * @return: success = 0, failure = -1
 */
PCIE_API AX_S32 AX_PCIe_SendDataReadyMsg(AX_S32 Target, AX_S32 Port, AX_U64 Addr, AX_U32 Size)
{
    AX_S32  Ret;
 ...
 * @return: success = 0, failure = -1
 */
PCIE_API AX_S32 AX_PCIe_SendWriteDoneMsg(AX_S32 Target, AX_S32 Port, AX_U64 Addr, AX_U32 Size)
{
    AX_S32  Ret;
    PCIE_DMA_MSG_DATA_T Data;
 ...
 * @return: success = 0, failure = -1
 */
PCIE_API AX_S32 AX_PCIe_SendReadDoneMsg(AX_S32 Target, AX_S32 Port, AX_U32 Size)
{
    AX_S32  Ret;
    PCIE_DMA_MSG_DATA_T Data;
 ...
 */
PCIE_API AX_S32 AX_PCIe_WaitWriteDoneMsg(AX_S32 Target, AX_S32 Port, AX_U64 *Addr, AX_U32 *Size, AX_S32 nTimeOut)
{
    AX_S32  Ret;
    PCIE_DMA_MSG_T PCIeDmaMsg;
    PCIE_DMA_MSG_DATA_T Data;
 ...
 * @return: success = 0, failure = -1, timeout = -2
 */
PCIE_API AX_S32 AX_PCIe_WaitDataReadyMsg(AX_S32 Target, AX_S32 Port, AX_U64 *Addr, AX_U32 *Size, AX_S32 nTimeOut)
{
    AX_S32  Ret;
    PCIE_DMA_MSG_T PCIeDmaMsg;
    PCIE_DMA_MSG_DATA_T Data;
 ...
 */
PCIE_API AX_S32 AX_PCIe_WaitReadDoneMsg(AX_S32 Target, AX_S32 Port, AX_S32 nTimeOut)
{
    AX_S32  Ret;
    PCIE_DMA_MSG_T PCIeDmaMsg;
    PCIE_DMA_MSG_DATA_T Data;
 ...
 * @return: success = 0, failure = -1
 */
PCIE_API AX_S32 AX_PCIe_SendUserCmd(AX_S32 Target, AX_S32 Port, AX_U32 Cmd)
{
    AX_S32  Ret;
    PCIE_DMA_MSG_DATA_T Data;
 ...
 */
PCIE_API AX_S32 AX_PCIe_WaitUserCmd(AX_S32 Target, AX_S32 Port, AX_S32 nTimeOut)
{
    AX_S32  Ret;
    PCIE_DMA_MSG_T PCIeDmaMsg;
    PCIE_DMA_MSG_DATA_T Data;
 ...
 * @return: success = 0, failure = -1
 */
PCIE_API AX_S32 AX_PCIe_SendRcPhyBaseAddr(AX_S32 Target, AX_S32 Port, AX_U64 RcPhyBaseAddr)
{
    AX_S32  Ret;
    PCIE_DMA_MSG_DATA_T Data;
 ...
 * @return: success = 0, failure = -1
 */
PCIE_API AX_S32 AX_PCIe_WaitRcPhyBaseAddr(AX_S32 Port, AX_U64 *RcPhyBaseAddr, AX_S32 nTimeOut)
{
    AX_S32  Ret;
    PCIE_DMA_MSG_T PCIeDmaMsg;
    PCIE_DMA_MSG_DATA_T Data;
 ...
 * @return: success = 0, failure = -1
 */
PCIE_API AX_S32 AX_PCIe_CreatDmaTask(AX_S32 PCIeDmaHandle, AX_PCIE_DMA_CH_TYPE_E Dir, AX_U64 Src, AX_U64 Dst, AX_U32 Len, AX_U32 Last)
{
 ...
 * @return: success = 0, failure = -1
 */
PCIE_API AX_S32 AX_PCIe_CreatDmaMultiTask(AX_S32 PCIeDmaHandle, AX_BOOL IsRead, AX_U32 Count, AX_PCIE_DMA_BLOCK_T stDmaBlk[])
{
...
/**
 * @description: create multiple dma link list task.
 * @param {AX_S32} PCIeDmaHandle: pcie dma device handler
 * @param {AX_PCIE_DMA_BLOCK_T} stDmaBlk: dma task blocks
 * @param {AX_U32} Count: the number of dma task
 * @param {AX_BOOL} IsRead: dma read = true, dma write = false
 * @return: success = 0, failure = -1
 */
PCIE_API AX_S32 AX_PCIe_CreatDmaLlpTask(AX_S32 PCIeDmaHandle, AX_PCIE_DMA_BLOCK_T stDmaBlk[], AX_U32 Count, AX_BOOL IsRead)
{
    PCIE_DMA_TASK_T  stTask;
    AX_S32 Ret = 0;
    ...
    Ret = ioctl(PCIeDmaHandle, PCIE_DMA_LLP_TASK, &stTask);
    if (Ret) {
        AX_PCIE_ERR("pcie dma multi task transfer failed\n");
        return -1;
    } else {
 ...
 */
PCIE_API AX_S32 AX_PCIe_OpenDmaDev(void)
{
...
PCIE_API AX_S32 AX_PCIe_CloseDmaDev(AX_S32 PCIeDmaHandle)
{
    AX_S32 Ret;
