...
#define printf(...) xt_printf(__VA_ARGS__)
#  define XV_CHECK_ERROR(condition, statment, code, wide_description)          \
...
#define XV_ARRAY_STARTS_IN_DRAM(t) \
  (((unsigned int) XV_ARRAY_GET_BUFF_PTR(t)) >= ((unsigned int) TM_DRAM_LOWER_ADDR))
#define XV_ARRAY_ENDS_IN_DRAM(t) \
  ((((uint64_t) (uint32_t) XV_ARRAY_GET_BUFF_PTR(t)) + ((uint64_t) XV_ARRAY_GET_BUFF_SIZE(t))) <= ((uint64_t) TM_DRAM_HIGHER_ADDR))
#define XV_TILE_STARTS_IN_DRAM(t) \
  (((unsigned int) XV_TILE_GET_BUFF_PTR(t)) >= ((unsigned int) TM_DRAM_LOWER_ADDR))
#define XV_TILE_ENDS_IN_DRAM(t) \
  ((((uint64_t) (uint32_t) XV_TILE_GET_BUFF_PTR(t)) + ((uint64_t) XV_TILE_GET_BUFF_SIZE(t))) <= ((uint64_t) TM_DRAM_HIGHER_ADDR))

#define XV_PTR_START_IN_DRAM(t) \
  (((unsigned int) (t)) >= (((unsigned int ) TM_DRAM_LOWER_ADDR)))

#define XV_PTR_END_IN_DRAM(t) \
  (((uint64_t)(t) ) <=  (((unsigned int ) TM_DRAM_HIGHER_ADDR)))
