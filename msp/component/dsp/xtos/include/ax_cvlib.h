...
AX_S32 AX_DSP_NV12Blending(AX_DSP_MESSAGE_T *msg);
AX_S32 AX_DSP_COPY(AX_DSP_MESSAGE_T *msg);
AX_S32 AX_DSP_FIK(AX_DSP_MESSAGE_T *msg);
AX_S32 AX_DSP_NV12Rotate360(AX_DSP_MESSAGE_T *msg);
AX_S32 AX_DSP_GDC_Mesh(AX_DSP_MESSAGE_T *msg);
AX_S32 AX_DSP_DFT_Init(AX_DSP_MESSAGE_T *msg);
AX_S32 AX_DSP_DFT_Run(AX_DSP_MESSAGE_T *msg);
AX_S32 AX_DSP_SAD_EX(AX_DSP_MESSAGE_T *msg);
