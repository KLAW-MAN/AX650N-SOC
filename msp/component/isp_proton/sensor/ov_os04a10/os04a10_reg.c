...
AX_U8 gOs04A10SlaveAddr[AX_VIN_MAX_PIPE_NUM] = {0x36 , 0x10, 0x36, 0x10, 0x36 , 0x10, 0x36, 0x10};
...
AX_S32 os04a10_set_slaveaddr(ISP_PIPE_ID nPipeId, AX_U8 nslaveaddr)
{
    ...
    if (nslaveaddr == OS04A10_SLAVE_ADDR1 || nslaveaddr == OS04A10_SLAVE_ADDR2)
        ...
        gOs04A10SlaveAddr[nPipeId] = OS04A10_SLAVE_ADDR;
    return SNS_SUCCESS;
}
...
AX_S32 os04a10_sensor_i2c_init(ISP_PIPE_ID nPipeId)
{
    ...
    SNS_DBG("os04a10 i2c init finish, i2c bus %d slave addr %#x \n", sns_obj->sns_i2c_obj.sns_i2c_bnum, sns_obj->sns_i2c_obj.slave_addr);
...
AX_S32 os04a10_select_setting(ISP_PIPE_ID nPipeId, camera_i2c_reg_array **setting, AX_U32 *cnt)
{
    ...
    /* SyncMasterSlave */
    case e_OS04A10_4lane_SyncMaster_2688x1520_10bit_Linear_30fps:
        *setting = OS04A10_4lane_SyncMaster_2688x1520_10bit_Linear_30fps;
        *cnt = sizeof(OS04A10_4lane_SyncMaster_2688x1520_10bit_Linear_30fps) / sizeof(camera_i2c_reg_array);
        break;

    case e_OS04A10_4lane_SyncSlave_2688x1520_10bit_Linear_30fps:
        *setting = OS04A10_4lane_SyncSlave_2688x1520_10bit_Linear_30fps;
        *cnt = sizeof(OS04A10_4lane_SyncSlave_2688x1520_10bit_Linear_30fps) / sizeof(camera_i2c_reg_array);
        break;

    case e_OS04A10_4lane_SyncMaster_2688x1520_10bit_2Stagger_HDR_30fps:
        *setting = OS04A10_4lane_SyncMaster_2688x1520_10bit_2Stagger_HDR_30fps;
        *cnt = sizeof(OS04A10_4lane_SyncMaster_2688x1520_10bit_2Stagger_HDR_30fps) / sizeof(camera_i2c_reg_array);
        break;

    case e_OS04A10_4lane_SyncSlave_2688x1520_10bit_2Stagger_HDR_30fps:
        *setting = OS04A10_4lane_SyncSlave_2688x1520_10bit_2Stagger_HDR_30fps;
        *cnt = sizeof(OS04A10_4lane_SyncSlave_2688x1520_10bit_2Stagger_HDR_30fps) / sizeof(camera_i2c_reg_array);
        break;

    /* 4 lane SDR 60fps */
    case e_OS04A10_4lane_2688x1520_10bit_Linear_60fps:
        *setting = OS04A10_4lane_2688x1520_10bit_Linear_60fps;
