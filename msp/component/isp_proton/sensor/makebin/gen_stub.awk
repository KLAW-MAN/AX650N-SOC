...
else if (index($2, "_DS_"))
    print "    {AX_ISP_PARAM_DS, &"$3"},"
else if (index($2, "_FPN_"))
    print "    {AX_ISP_PARAM_FPN, &"$3"},"
...
else if (index($2, "_CAF_"))
    print "    {AX_ISP_PARAM_CAF, &"$3"},"
...
else if (index($2, "_LDC_"))
    print "    {AX_ISP_PARAM_LDC, &"$3"},"
else if (index($2, "_DIS_"))
    print "    {AX_ISP_PARAM_DIS, &"$3"},"
else if (index($2, "_ME_"))
    print "    {AX_ISP_PARAM_ME, &"$3"},"
}
END {
