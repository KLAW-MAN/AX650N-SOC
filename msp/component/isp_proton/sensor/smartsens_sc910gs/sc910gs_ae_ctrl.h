...
#ifndef __SC910GS_AE_CTRL_H__
#define __SC910GS_AE_CTRL_H__
...
AX_S32 sc910gs_get_integration_time_range(ISP_PIPE_ID nPipeId, AX_F32 fHdrRatio, AX_SNS_AE_INT_TIME_RANGE_T *ptIntTimeRange);
...
#endif  //end __SC910GS_AE_CTRL_H__
