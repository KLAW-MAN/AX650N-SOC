...
AX_S32 os08a20_get_vts_from_setting(ISP_PIPE_ID nPipeId, camera_i2c_reg_array *setting, AX_U32 reg_cnt, AX_U32 *vts)
{
    AX_U32 i = 0;
    AX_U8 high = 0;
    AX_U8 low = 0;
    ...
    for (i = 0; i < reg_cnt; i++) {
        if((setting + i)->addr == OS08A20_VTS_H) {
            high = (setting + i)->value;
            mask |= 1;
        } else if((setting + i)->addr == OS08A20_VTS_L) {
            low = (setting + i)->value;
            mask |= 1 << 1;
        }
...
AX_S32 os08a20_get_hts_from_setting(ISP_PIPE_ID nPipeId, camera_i2c_reg_array *setting, AX_U32 reg_cnt, AX_U32 *hts)
{
    AX_U32 i = 0;
    AX_U8 high = 0;
    AX_U8 low = 0;
...
AX_S32 os08a20_get_sclk_from_setting(ISP_PIPE_ID nPipeId, camera_i2c_reg_array *setting, AX_U32 reg_cnt, AX_F32 *sclk)
{
    AX_U8 pre_div0 = 0;
    AX_U8 pre_div = 0;
    AX_U16 multiplier = 0;
...
AX_S32 os08a20_select_setting(ISP_PIPE_ID nPipeId, camera_i2c_reg_array **setting, AX_U32 *cnt)
{
    SNS_STATE_OBJ *sns_obj = AX_NULL;
    ...
    case e_OS08A20_4lane_3840x2160_Linear_10bit_30fps_1440Mbps:
        *setting = OS08A20_4lane_3840x2160_Linear_10bit_30fps_1440Mbps;
        *cnt = sizeof(OS08A20_4lane_3840x2160_Linear_10bit_30fps_1440Mbps) / sizeof(camera_i2c_reg_array);
        break;

    case e_OS08A20_4lane_3840x2160_Linear_10bit_25fps_1440Mbps:
        *setting = OS08A20_4lane_3840x2160_Linear_10bit_25fps_1440Mbps;
        *cnt = sizeof(OS08A20_4lane_3840x2160_Linear_10bit_25fps_1440Mbps) / sizeof(camera_i2c_reg_array);
        break;

    case e_OS08A20_4lane_3840x2160_Linear_12bit_25fps_1280Mbps:
        *setting = OS08A20_4lane_3840x2160_Linear_12bit_25fps_1280Mbps;
        *cnt = sizeof(OS08A20_4lane_3840x2160_Linear_12bit_25fps_1280Mbps) / sizeof(camera_i2c_reg_array);
        break;

    case e_OS08A20_4lane_3840x2160_Linear_12bit_30fps_1280Mbps:
        *setting = OS08A20_4lane_3840x2160_Linear_12bit_30fps_1280Mbps;
        *cnt = sizeof(OS08A20_4lane_3840x2160_Linear_12bit_30fps_1280Mbps) / sizeof(camera_i2c_reg_array);
        break;

    case e_OS08A20_4lane_3840x2160_hdr_10bit_25fps_1280Mbps:
        *setting = OS08A20_4lane_3840x2160_hdr_10bit_25fps_1280Mbps;
        *cnt = sizeof(OS08A20_4lane_3840x2160_hdr_10bit_25fps_1280Mbps) / sizeof(camera_i2c_reg_array);
        break;

    case e_OS08A20_4lane_3840x2160_hdr_10bit_30fps_1280Mbps:
        *setting = OS08A20_4lane_3840x2160_hdr_10bit_30fps_1280Mbps;
        *cnt = sizeof(OS08A20_4lane_3840x2160_hdr_10bit_30fps_1280Mbps) / sizeof(camera_i2c_reg_array);
        break;

    case e_OS08A20_4lane_3840x2160_Linear_10bit_60fps_1440Mbps:
        *setting = OS08A20_4lane_3840x2160_Linear_10bit_60fps_1440Mbps;
        *cnt = sizeof(OS08A20_4lane_3840x2160_Linear_10bit_60fps_1440Mbps) / sizeof(camera_i2c_reg_array);
        break;

    case e_OS08A20_4lane_3840x2160_Linear_10bit_50fps_1440Mbps:
        *setting = OS08A20_4lane_3840x2160_Linear_10bit_50fps_1440Mbps;
        *cnt = sizeof(OS08A20_4lane_3840x2160_Linear_10bit_50fps_1440Mbps) / sizeof(camera_i2c_reg_array);
        break;
...
AX_S32 os08a20_write_settings(ISP_PIPE_ID nPipeId)
{
    AX_U32 i = 0;
    AX_S32 ret = 0;
    AX_U32 reg_cnt = 0;
    ...
    for (i = 0; i < reg_cnt; i++) {
        os08a20_write_register(nPipeId, (setting + i)->addr, ((setting + i)->value));
#ifdef SENSOR_DEBUG
        usleep(2 * 1000);
        AX_U8 val = os08a20_reg_read(nPipeId, (default_setting + i)->addr);
