...
AX_S32 SampleDynRcMode(AX_S32 VeChn, AX_VOID *handle);

AX_S32 SampleDynProfileLevel(AX_S32 VeChn, AX_VOID *handle);

AX_S32 SampleVirIntraInterval(AX_S32 VeChn, AX_VOID *handle);

AX_S32 SampleIntraRefresh(AX_S32 VeChn, AX_VOID *handle);

AX_S32 SampleVencRoi(AX_S32 VeChn, AX_VOID *handle);

AX_S32 SampleDynResolution(AX_S32 VeChn, AX_VOID *handle);
