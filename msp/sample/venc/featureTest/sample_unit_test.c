...
Sample_Test_Case_T gTestCaseSet[SAMPLE_MAX_TESTCASE_NUM] = {
    ...
    VENC_TEST_CASE_INIT(UT_CASE_JPEG_EXIF, UTestJpegExif, NULL),
    VENC_TEST_CASE_INIT(UT_CASE_JPEG_SLICE, UTestDynamicAttr, SampleTestJencSliceSplit),
    VENC_TEST_CASE_INIT(UT_CASE_CHG_QPMAP, UTestDynamicAttr, SampleTestQpMap),
    VENC_TEST_CASE_INIT(UT_CASE_EPOLL, UTestEpoll, NULL),
    VENC_TEST_CASE_INIT(UT_CASE_CREATE_CHN_EX, UTestCreateChnEx, NULL),
};
