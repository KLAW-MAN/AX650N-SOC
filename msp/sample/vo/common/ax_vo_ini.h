...
typedef enum {
    ...
    AX_VO_INI_K_L_CHN_CLEAN_CTRL,
    AX_VO_INI_K_L_BATCH_CTRL,
    AX_VO_INI_K_L_MAX = AX_VO_INI_K_L_BATCH_CTRL,
    ...
    AX_VO_INI_K_D_DPMS_CTRL_ENABLE,
    AX_VO_INI_K_D_CRTC_CTRL_ENABLE,
    AX_VO_INI_K_D_HSV_CTRL_ENABLE,
    ...
    AX_VO_INI_K_D_HDMI_OUT_FMT,
    AX_VO_INI_K_D_CMD_AFTER_START,
