1) The test is used to verify the basic functions of the cipher module:
...
4) Things to note:
The test takes a long time. When running to the later performance case, you can exit with ctrl+c;
