...
#define SAMPLE_AVS_PIPE_NUM_MAX AX_AVS_PIPE_NUM
#define SAMPLE_AVS_PYRA_NUM_MAX AX_AVS_PYRA_NUM
...
typedef struct _SAMPLE_AVS_BASE_PARA
{
    ...
    AX_S32 s32MaskPyraNum;
    AX_S8 *pMask[SAMPLE_AVS_PIPE_NUM_MAX - 1][SAMPLE_AVS_PYRA_NUM_MAX];
    AX_S32 s32MaskWidth[SAMPLE_AVS_PIPE_NUM_MAX - 1];;
    AX_S32 s32MaskHeight[SAMPLE_AVS_PIPE_NUM_MAX - 1];;
    AX_S32 s32MaskX[SAMPLE_AVS_PIPE_NUM_MAX - 1];;
    AX_S32 s32MaskY[SAMPLE_AVS_PIPE_NUM_MAX - 1];;
    AX_S32 s32LoopNum;
...
static void *AVSSendFrameProc(void *arg) {
    ...
    FILE *fFileIn[AX_AVS_PIPE_NUM] = {NULL};
...
/* Tmp code: need adjust algo and hal structrue */
static AX_S32 AXGenMask(AX_S32 seam_idx, AX_AVS_GRP_TRANSFORM_PARAM_T *pstTransfromParam) {
    AX_S32 i, j;

    for (j = 0; j < pstTransfromParam->stSeamInfo[seam_idx].u16H; j++) {
        memset(pstTransfromParam->stMask.pstVirAddr[seam_idx][0] + j * pstTransfromParam->stSeamInfo[seam_idx].u16W, 0, pstTransfromParam->stSeamInfo[seam_idx].u16W / 2);

        memset(pstTransfromParam->stMask.pstVirAddr[seam_idx][0] + (2 * j + 1) * pstTransfromParam->stSeamInfo[seam_idx].u16W / 2, 255, pstTransfromParam->stSeamInfo[seam_idx].u16W / 2);
    }
...
static AX_S32 SampleAVSUsage(SAMPLE_AVS_BASE_PARA_T* pAVSBaseParam) {
    ...
    pAVSGrpAttr->u32MaskPyraNum = pAVSBaseParam->s32MaskPyraNum;
    ...
    memset(&pAVSGrpAttr->stGrpCameraParam, 0, sizeof(pAVSGrpAttr->stGrpCameraParam));
    if (pAVSBaseParam->s32CalibrationMode == 1) {
        ...
        pAVSGrpAttr->stGrpCameraParam.stImgFOV[2].u32FOVX = pAVSBaseParam->f32InputFOV[2];
        pAVSGrpAttr->stGrpCameraParam.stImgFOV[3].u32FOVX = pAVSBaseParam->f32InputFOV[3];
        pAVSGrpAttr->stGrpCameraParam.stImgFOV[4].u32FOVX = pAVSBaseParam->f32InputFOV[4];
        pAVSGrpAttr->stGrpCameraParam.stImgFOV[5].u32FOVX = pAVSBaseParam->f32InputFOV[5];
        pAVSGrpAttr->stGrpCameraParam.stImgFOV[6].u32FOVX = pAVSBaseParam->f32InputFOV[6];
        pAVSGrpAttr->stGrpCameraParam.stImgFOV[7].u32FOVX = pAVSBaseParam->f32InputFOV[7];
        ...
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[2].nTranslationParam[0] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[2].nTranslationParam[1] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[2].nTranslationParam[2] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[2].nTranslationParam[3] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[2].nTranslationParam[4] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[3].nTranslationParam[0] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[3].nTranslationParam[1] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[3].nTranslationParam[2] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[3].nTranslationParam[3] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[3].nTranslationParam[4] = 0;

        // test 555.txt
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[0].nRotationParam[0] = -158.11;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[0].nRotationParam[1] = 1.14;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[0].nRotationParam[2] = 89.38;

        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[1].nRotationParam[0] = -114.81;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[1].nRotationParam[1] = 1.49;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[1].nRotationParam[2] = -91.55;

        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[2].nRotationParam[0] = -66.62;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[2].nRotationParam[1] = 1.48;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[2].nRotationParam[2] = 92.11;

        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[3].nRotationParam[0] = -21.92;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[3].nRotationParam[1] = 1.49;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[3].nRotationParam[2] = -89.29;

        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[4].nRotationParam[0] = 24.64;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[4].nRotationParam[1] = 0.91;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[4].nRotationParam[2] = 89.73;

        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[5].nRotationParam[0] = 69.91;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[5].nRotationParam[1] = -0.29;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[5].nRotationParam[2] = -91.82;

        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[6].nRotationParam[0] = 113.34;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[6].nRotationParam[1] = 2.95;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[6].nRotationParam[2] = 89.21;

        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[7].nRotationParam[0] = 158.11;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[7].nRotationParam[1] = 1.28;
        pAVSGrpAttr->stGrpCameraParam.stPipeExtrinsic[7].nRotationParam[2] = -91.45;

        // 555.txt
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[0].nDistortionCoeff[0] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[0].nDistortionCoeff[1] = -0.0586;
        ...
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[1].nDistortionCoeff[1] = -0.0586;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[1].nDistortionCoeff[2] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[2].nDistortionCoeff[0] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[2].nDistortionCoeff[1] = -0.0586;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[2].nDistortionCoeff[2] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[3].nDistortionCoeff[0] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[3].nDistortionCoeff[1] = -0.0586;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[3].nDistortionCoeff[2] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[4].nDistortionCoeff[0] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[4].nDistortionCoeff[1] = -0.0586;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[4].nDistortionCoeff[2] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[5].nDistortionCoeff[0] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[5].nDistortionCoeff[1] = -0.0586;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[5].nDistortionCoeff[2] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[6].nDistortionCoeff[0] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[6].nDistortionCoeff[1] = -0.0586;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[6].nDistortionCoeff[2] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[7].nDistortionCoeff[0] = 0;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[7].nDistortionCoeff[1] = -0.0586;
        pAVSGrpAttr->stGrpCameraParam.stPipeIntrinsic[7].nDistortionCoeff[2] = 0;
        ...
        pAVSGrpAttr->stOutAttr.u32Width = s32OutputWidth;
        pAVSGrpAttr->stOutAttr.u32Height = s32OutputHeight;
        ...
        for (AX_S32 i = 0; i < s32PipeNum - 1; i++) {
            pAVSGrpAttr->stGrpTransformParam.stSeamInfo[i].u16W = pAVSBaseParam->s32MaskWidth[i];
            pAVSGrpAttr->stGrpTransformParam.stSeamInfo[i].u16H = pAVSBaseParam->s32MaskHeight[i];
            pAVSGrpAttr->stGrpTransformParam.stSeamInfo[i].u16X = pAVSBaseParam->s32MaskX[i];
            pAVSGrpAttr->stGrpTransformParam.stSeamInfo[i].u16Y = pAVSBaseParam->s32MaskY[i];
#if 0
            pAVSGrpAttr->stGrpTransformParam.stMask.s32MaskSize[i][0] = pAVSGrpAttr->stGrpTransformParam.stSeamInfo[i].u16W *
                                                                    pAVSGrpAttr->stGrpTransformParam.stSeamInfo[i].u16H;
            pAVSGrpAttr->stGrpTransformParam.stMask.pstVirAddr[i][0] = malloc(pAVSGrpAttr->stGrpTransformParam.stMask.s32MaskSize[i][0]);
#endif
        }
        ...
        for (AX_S32 i = 0; i < s32PipeNum; i++) {
            if (i) {
#if 0
                AXGenMask(i - 1, &pAVSGrpAttr->stGrpTransformParam);
                SAMPLE_DEBUG_LOG("Mask %d, pyra 0 Viraddr %p, size %d\n", i - 1, pAVSGrpAttr->stGrpTransformParam.stMask.pstVirAddr[i - 1][0],
                                pAVSGrpAttr->stGrpTransformParam.stMask.s32MaskSize[i - 1][0]);
#else
                for (AX_S32 j = 0; j < pAVSBaseParam->s32MaskPyraNum; j++) {
	                s32Ret = LoadFileToMem((AX_CHAR*)pAVSBaseParam->pMask[i - 1][j], (AX_U8**)&pAVSGrpAttr->stGrpTransformParam.stMask.pstVirAddr[i - 1][j],
	                                    (AX_S32*)&pAVSGrpAttr->stGrpTransformParam.stMask.s32MaskSize[i - 1][j]);
	                if (s32Ret) {
	                    SAMPLE_ERR_LOG("Mask %d LoadFileToMem failed!\n", j);
	                    return -1;
	                }
	                SAMPLE_DEBUG_LOG("Mask grp %d, pyra %d, Viraddr %p, size %d\n", i - 1, j, pAVSGrpAttr->stGrpTransformParam.stMask.pstVirAddr[i - 1][j],
	                                pAVSGrpAttr->stGrpTransformParam.stMask.s32MaskSize[i - 1][j]);
	            }
#endif
            }
...
*/
    pAVSGrpAttr->eEngineMode = pAVSBaseParam->s32DewarpMode;
...
static AX_S32 AVSParameterGet(AX_S32 argc, AX_CHAR **argv, SAMPLE_AVS_BASE_PARA_T* pAVSBaseParam) {
    ...
    pAVSBaseParam->s32MaskPyraNum = ini_getint(ini, ax_strcat(cKey, "avs_attr", ":mask_pyra_num"), 0);
    ...
    pAVSBaseParam->s32DewarpMode = ini_getint(ini, ax_strcat(cKey, "avs_attr", ":dewarp_mode"), 0);

    /* Pipe0 param */
    pAVSBaseParam->pInput[0] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe0", ":input_image"), 0);
    pAVSBaseParam->f32InputFOV[0] = ini_getdouble(ini, ax_strcat(cKey, "avs_pipe0", ":input_fov"), 0);
    pAVSBaseParam->pMesh[0] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe0", ":pipe_mesh"), 0);
    /* Pipe1 param */
    pAVSBaseParam->pInput[1] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe1", ":input_image"), 0);
    pAVSBaseParam->f32InputFOV[1] = ini_getdouble(ini, ax_strcat(cKey, "avs_pipe1", ":input_fov"), 0);
    pAVSBaseParam->pMesh[1] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe1", ":pipe_mesh"), 0);
    /* Pipe2 param */
    pAVSBaseParam->pInput[2] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe2", ":input_image"), 0);
    pAVSBaseParam->f32InputFOV[2] = ini_getdouble(ini, ax_strcat(cKey, "avs_pipe2", ":input_fov"), 0);
    pAVSBaseParam->pMesh[2] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe2", ":pipe_mesh"), 0);
    /* Pipe3 param */
    pAVSBaseParam->pInput[3] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe3", ":input_image"), 0);
    pAVSBaseParam->f32InputFOV[3] = ini_getdouble(ini, ax_strcat(cKey, "avs_pipe3", ":input_fov"), 0);
    pAVSBaseParam->pMesh[3] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe3", ":pipe_mesh"), 0);
    /* Pipe4 param */
    pAVSBaseParam->pInput[4] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe4", ":input_image"), 0);
    pAVSBaseParam->f32InputFOV[4] = ini_getdouble(ini, ax_strcat(cKey, "avs_pipe4", ":input_fov"), 0);
    pAVSBaseParam->pMesh[4] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe4", ":pipe_mesh"), 0);
    /* Pipe5 param */
    pAVSBaseParam->pInput[5] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe5", ":input_image"), 0);
    pAVSBaseParam->f32InputFOV[5] = ini_getdouble(ini, ax_strcat(cKey, "avs_pipe5", ":input_fov"), 0);
    pAVSBaseParam->pMesh[5] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe5", ":pipe_mesh"), 0);
    /* Pipe6 param */
    pAVSBaseParam->pInput[6] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe6", ":input_image"), 0);
    pAVSBaseParam->f32InputFOV[6] = ini_getdouble(ini, ax_strcat(cKey, "avs_pipe6", ":input_fov"), 0);
    pAVSBaseParam->pMesh[6] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe6", ":pipe_mesh"), 0);
    /* Pipe7 param */
    pAVSBaseParam->pInput[7] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe7", ":input_image"), 0);
    pAVSBaseParam->f32InputFOV[7] = ini_getdouble(ini, ax_strcat(cKey, "avs_pipe7", ":input_fov"), 0);
    pAVSBaseParam->pMesh[7] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_pipe7", ":pipe_mesh"), 0);

    /* Seam0 param */
    pAVSBaseParam->pMask[0][0] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam0", ":mask_file_pyra0"), 0);
    pAVSBaseParam->pMask[0][1] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam0", ":mask_file_pyra1"), 0);
    pAVSBaseParam->pMask[0][2] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam0", ":mask_file_pyra2"), 0);
    pAVSBaseParam->s32MaskWidth[0] = ini_getint(ini, ax_strcat(cKey, "avs_seam0", ":mask_width"), 0);
    pAVSBaseParam->s32MaskHeight[0] = ini_getint(ini, ax_strcat(cKey, "avs_seam0", ":mask_height"), 0);
    pAVSBaseParam->s32MaskX[0] = ini_getint(ini, ax_strcat(cKey, "avs_seam0", ":mask_x"), 0);
    pAVSBaseParam->s32MaskY[0] = ini_getint(ini, ax_strcat(cKey, "avs_seam0", ":mask_y"), 0);
    /* Seam1 param */
    pAVSBaseParam->pMask[1][0] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam1", ":mask_file_pyra0"), 0);
    pAVSBaseParam->pMask[1][1] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam1", ":mask_file_pyra1"), 0);
    pAVSBaseParam->pMask[1][2] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam1", ":mask_file_pyra2"), 0);
    pAVSBaseParam->s32MaskWidth[1] = ini_getint(ini, ax_strcat(cKey, "avs_seam1", ":mask_width"), 0);
    pAVSBaseParam->s32MaskHeight[1] = ini_getint(ini, ax_strcat(cKey, "avs_seam1", ":mask_height"), 0);
    pAVSBaseParam->s32MaskX[1] = ini_getint(ini, ax_strcat(cKey, "avs_seam1", ":mask_x"), 0);
    pAVSBaseParam->s32MaskY[1] = ini_getint(ini, ax_strcat(cKey, "avs_seam1", ":mask_y"), 0);
    /* Seam2 param */
    pAVSBaseParam->pMask[2][0] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam2", ":mask_file_pyra0"), 0);
    pAVSBaseParam->pMask[2][1] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam2", ":mask_file_pyra1"), 0);
    pAVSBaseParam->pMask[2][2] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam2", ":mask_file_pyra2"), 0);
    pAVSBaseParam->s32MaskWidth[2] = ini_getint(ini, ax_strcat(cKey, "avs_seam2", ":mask_width"), 0);
    pAVSBaseParam->s32MaskHeight[2] = ini_getint(ini, ax_strcat(cKey, "avs_seam2", ":mask_height"), 0);
    pAVSBaseParam->s32MaskX[2] = ini_getint(ini, ax_strcat(cKey, "avs_seam2", ":mask_x"), 0);
    pAVSBaseParam->s32MaskY[2] = ini_getint(ini, ax_strcat(cKey, "avs_seam2", ":mask_y"), 0);
    /* Seam3 param */
    pAVSBaseParam->pMask[3][0] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam3", ":mask_file_pyra0"), 0);
    pAVSBaseParam->pMask[3][1] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam3", ":mask_file_pyra1"), 0);
    pAVSBaseParam->pMask[3][2] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam3", ":mask_file_pyra2"), 0);
    pAVSBaseParam->s32MaskWidth[3] = ini_getint(ini, ax_strcat(cKey, "avs_seam3", ":mask_width"), 0);
    pAVSBaseParam->s32MaskHeight[3] = ini_getint(ini, ax_strcat(cKey, "avs_seam3", ":mask_height"), 0);
    pAVSBaseParam->s32MaskX[3] = ini_getint(ini, ax_strcat(cKey, "avs_seam3", ":mask_x"), 0);
    pAVSBaseParam->s32MaskY[3] = ini_getint(ini, ax_strcat(cKey, "avs_seam3", ":mask_y"), 0);
    /* Seam4 param */
    pAVSBaseParam->pMask[4][0] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam4", ":mask_file_pyra0"), 0);
    pAVSBaseParam->pMask[4][1] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam4", ":mask_file_pyra1"), 0);
    pAVSBaseParam->pMask[4][2] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam4", ":mask_file_pyra2"), 0);
    pAVSBaseParam->s32MaskWidth[4] = ini_getint(ini, ax_strcat(cKey, "avs_seam4", ":mask_width"), 0);
    pAVSBaseParam->s32MaskHeight[4] = ini_getint(ini, ax_strcat(cKey, "avs_seam4", ":mask_height"), 0);
    pAVSBaseParam->s32MaskX[4] = ini_getint(ini, ax_strcat(cKey, "avs_seam4", ":mask_x"), 0);
    pAVSBaseParam->s32MaskY[4] = ini_getint(ini, ax_strcat(cKey, "avs_seam4", ":mask_y"), 0);
    /* Seam5 param */
    pAVSBaseParam->pMask[5][0] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam5", ":mask_file_pyra0"), 0);
    pAVSBaseParam->pMask[5][1] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam5", ":mask_file_pyra1"), 0);
    pAVSBaseParam->pMask[5][2] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam5", ":mask_file_pyra2"), 0);
    pAVSBaseParam->s32MaskWidth[5] = ini_getint(ini, ax_strcat(cKey, "avs_seam5", ":mask_width"), 0);
    pAVSBaseParam->s32MaskHeight[5] = ini_getint(ini, ax_strcat(cKey, "avs_seam5", ":mask_height"), 0);
    pAVSBaseParam->s32MaskX[5] = ini_getint(ini, ax_strcat(cKey, "avs_seam5", ":mask_x"), 0);
    pAVSBaseParam->s32MaskY[5] = ini_getint(ini, ax_strcat(cKey, "avs_seam5", ":mask_y"), 0);
    /* Seam6 param */
    pAVSBaseParam->pMask[6][0] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam6", ":mask_file_pyra0"), 0);
    pAVSBaseParam->pMask[6][1] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam6", ":mask_file_pyra1"), 0);
    pAVSBaseParam->pMask[6][2] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_seam6", ":mask_file_pyra2"), 0);
    pAVSBaseParam->s32MaskWidth[6] = ini_getint(ini, ax_strcat(cKey, "avs_seam6", ":mask_width"), 0);
    pAVSBaseParam->s32MaskHeight[6] = ini_getint(ini, ax_strcat(cKey, "avs_seam6", ":mask_height"), 0);
    pAVSBaseParam->s32MaskX[6] = ini_getint(ini, ax_strcat(cKey, "avs_seam6", ":mask_x"), 0);
    pAVSBaseParam->s32MaskY[6] = ini_getint(ini, ax_strcat(cKey, "avs_seam6", ":mask_y"), 0);
    ...
    if (pAVSBaseParam->s32CalibrationMode) {
        printf(cFmtfloat, "Pipe0 FOVX", pAVSBaseParam->f32InputFOV[0]);
        ...
        printf(cFmtint, "Mask pyra num", pAVSBaseParam->s32MaskPyraNum);
        printf(cFmtstr, "Seam0 Mask pyra0", pAVSBaseParam->pMask[0][0]);
        printf(cFmtstr, "Seam0 Mask pyra1", pAVSBaseParam->pMask[0][1]);
        printf(cFmtstr, "Seam0 Mask pyra2", pAVSBaseParam->pMask[0][2]);
        printf(cFmtint, "Seam0 width", pAVSBaseParam->s32MaskWidth[0]);
        printf(cFmtint, "Seam0 height", pAVSBaseParam->s32MaskHeight[0]);
        printf(cFmtint, "Seam0 x", pAVSBaseParam->s32MaskX[0]);
        printf(cFmtint, "Seam0 y", pAVSBaseParam->s32MaskY[0]);
        printf(cFmtint, "Seam1 width", pAVSBaseParam->s32MaskWidth[1]);
        printf(cFmtint, "Seam1 height", pAVSBaseParam->s32MaskHeight[1]);
        printf(cFmtint, "Seam1 x", pAVSBaseParam->s32MaskX[1]);
        printf(cFmtint, "Seam1 y", pAVSBaseParam->s32MaskY[1]);
    }

    printf(cFmtstr, "Pipe0 file", pAVSBaseParam->pInput[0]);
    printf(cFmtstr, "Pipe0 mesh", pAVSBaseParam->pMesh[0]);
...
static AX_S32 dsp_init(void)
{
    ...
    for (dspid = 0; dspid < 2; dspid++ )
    {
        ...
        if (ret) {
            SAMPLE_ERR_LOG("AX DSP[%d] Poweron error %x\n", dspid, ret);
            return -1;
        }
        ret = AX_DSP_LoadBin(dspid, "/opt/data/dsp/sram.bin", AX_DSP_MEM_TYPE_SRAM);
        if (ret) {
            SAMPLE_ERR_LOG("AX DSP[%d] LoadBin error %x\n", dspid, ret);
            return -1;
        }
        ...
        if (ret) {
            SAMPLE_ERR_LOG("AX DSP[%d] Enable Core error %x\n", dspid, ret);
            return -1;
        }
    }
...
AX_S32 main(AX_S32 argc, AX_CHAR *argv[]) {
    ...
    s32Ret = dsp_init();
    if(s32Ret) {
        SAMPLE_ERR_LOG("dsp_init failed! Error Code:0x%X\n", s32Ret);
        goto err2;
    }
