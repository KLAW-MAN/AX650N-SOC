...
#define SAMPLE_AVS_PYRA_NUM_MAX 3
...
static AX_S32 AVSParameterGet(AX_S32 argc, AX_CHAR **argv, SAMPLE_AVS_BASE_PARA_T* pAVSBaseParam) {
    ...
    pAVSBaseParam->pMask[0][0] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_attr", ":mask_file_pyra0"), 0);
    pAVSBaseParam->pMask[0][1] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_attr", ":mask_file_pyra1"), 0);
    pAVSBaseParam->pMask[0][2] = (AX_S8*)ini_get_string(ini, ax_strcat(cKey, "avs_attr", ":mask_file_pyra2"), 0);
    ...
    printf(cFmtstr, "Mask pyra0", pAVSBaseParam->pMask[0][0]);
    printf(cFmtstr, "Mask pyra1", pAVSBaseParam->pMask[0][1]);
    printf(cFmtstr, "Mask pyra2", pAVSBaseParam->pMask[0][2]);
