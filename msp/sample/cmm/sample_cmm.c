...
/*
* test AX_SYS_MmapCache/AX_SYS_MflushCache/AX_SYS_Munmap Unmanaged mode
* should pass
*/
static int ax_mem_cmm_test_015(void)
{
    AX_U64 PhyAddr = 0x180000000;//The physical address must not be used by the current process
    AX_VOID *pVirAddr;
    AX_VOID *pVirAddr2;
...
/*
* test AX_SYS_MmapCache/AX_SYS_MinvalidateCache/AX_SYS_Munmap Unmanaged mode
* should pass
*/
...
static int ax_mem_cmm_test_020(void)
{
    ...
    /* Map a single block in the pool */
