...
AX_IVES_IMAGE_T *SAMPLE_LOAD_IMAGE(const AX_CHAR *pImgFile, AX_U32 u32Width, AX_U32 u32Height,
                                   AX_IMG_FORMAT_E eImgType) {
    AX_IVES_IMAGE_T *pstImg = NULL;
    AX_U64 u64PhyAddr;
    AX_U64 u64VirAddr;
    ...
    pstImg = (AX_IVES_IMAGE_T *)malloc(sizeof(AX_IVES_IMAGE_T));
    if (pstImg) {
