...
typedef enum AX_ISP_3A_FLICKER_MODE_S
{
    AX_ISP_FLICKER_DISABLE       = 0,
    AX_ISP_FLICKER_MANUAL_ANTI   = 1,
    AX_ISP_FLICKER_AUTO_DET      = 2,
    AX_ISP_FLICKER_AUTO_ANTI     = 3,
} AX_ISP_3A_FLICKER_MODE_S;
...
typedef struct{
    AX_U8  antiflickerMode;       /* 0: Antiflicker off; 1: manual antiflicker on; 2：auto flicker det; 3: auto anti flicker*/
...
typedef struct {
    ...
    AX_F32 flineTime;         /* Float type each exposure line spend time, unit:us */
    AX_F32 fReadLineTime;     /* Float type each readout line spend time, unit:us */
