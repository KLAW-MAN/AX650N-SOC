 ...
 */
static inline AX_VOID AX_OSAL_LIB_list_add(struct AX_LIST_HEAD *_new, struct AX_LIST_HEAD *_head)
{
 ...
 */
static inline AX_VOID AX_OSAL_LIB_list_add_tail(struct AX_LIST_HEAD *_new, struct AX_LIST_HEAD *_head)
{
...
static inline AX_VOID AX_OSAL_LIB_list_del(struct AX_LIST_HEAD *_entry)
{
    AX_OSAL___list_del(_entry->prev, _entry->next);
 ...
 */
static inline AX_VOID AX_OSAL_LIB_list_replace(struct AX_LIST_HEAD *_old, struct AX_LIST_HEAD *_new)
{
    _new->next = _old->next;
    _new->next->prev = _new;
    _new->prev = _old->prev;
...
static inline AX_VOID AX_OSAL_LIB_list_replace_init(struct AX_LIST_HEAD *_old, struct AX_LIST_HEAD *_new)
{
 ...
 * @entry: the element to delete from the list.
 */
static inline AX_VOID AX_OSAL_LIB_list_del_init(struct AX_LIST_HEAD *_entry)
{
 ...
 */
static inline AX_VOID AX_OSAL_LIB_list_move(struct AX_LIST_HEAD *_list, struct AX_LIST_HEAD *_head)
{
 ...
 */
static inline AX_VOID AX_OSAL_LIB_list_move_tail(struct AX_LIST_HEAD *_list, struct AX_LIST_HEAD *_head)
{
    AX_OSAL___list_del_entry(_list);
 ...
 */
static inline AX_S32 AX_OSAL_LIB_list_is_last(struct AX_LIST_HEAD *_list, struct AX_LIST_HEAD *_head)
{
 ...
 */
static inline AX_S32 AX_OSAL_LIB_list_empty(struct AX_LIST_HEAD *_head)
{
 ...
 * @head: the head of the list
 */
static inline AX_VOID AX_OSAL_LIB_list_rotate_left(struct AX_LIST_HEAD *_head)
{
 ...
 */
static inline AX_VOID AX_OSAL_LIB_list_splice(struct AX_LIST_HEAD *_list, struct AX_LIST_HEAD *_head)
{
 ...
 * @head: the place to add it in the first list.
 */
static inline AX_VOID AX_OSAL_LIB_list_splice_tail(struct AX_LIST_HEAD *_list, struct AX_LIST_HEAD *_head)
{
    if (!AX_OSAL_LIB_list_empty(_list))
 ...
 */
static inline AX_VOID AX_OSAL_LIB_list_splice_init(struct AX_LIST_HEAD *_list, struct AX_LIST_HEAD *_head)
{
    if (!AX_OSAL_LIB_list_empty(_list)) {
        AX_OSAL___list_splice(_list, _head, _head->next);
 ...
 * The list at @list is reinitialised
 */
static inline AX_VOID AX_OSAL_LIB_list_splice_tail_init(struct AX_LIST_HEAD *_list, struct AX_LIST_HEAD *_head)
{
    if (!AX_OSAL_LIB_list_empty(_list)) {
        AX_OSAL___list_splice(_list, _head->prev, _head);
        AX_OSAL_LIB_init_list_head(_list);
