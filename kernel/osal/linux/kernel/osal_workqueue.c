...
AX_S32 AX_OSAL_SYNC_init_delayed_work(AX_WORK_T * osal_work, AX_WORK_FUNC_T func)
{
...
AX_S32 AX_OSAL_SYNC_schedule_delayed_work(AX_WORK_T * osal_work, AX_ULONG delay)
{
...
AX_VOID AX_OSAL_SYNC_destroy_delayed_work(AX_WORK_T * osal_work)
{
	if (osal_work != NULL && osal_work->work != NULL) {
