...
#define AXERA_APB_TIMER_COUNT		6
...
#define APBTMR_N_INIT_STATUS(N)		(0x10 + (N) * 0x14)
...
struct axera_dw_apb_timer {
	...
	struct reset_control *reset[PER_TIMER_CHANNEL_COUNT];
	struct clk *pclk;
	struct clk *clk[PER_TIMER_CHANNEL_COUNT];
};
