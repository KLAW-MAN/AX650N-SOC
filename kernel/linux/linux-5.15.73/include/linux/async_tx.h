...
#if defined(CONFIG_AXERA_ASYNC_TX_DMA) \
	 && !defined(CONFIG_ASYNC_TX_DMA)
extern struct dma_chan *axera_async_tx_find_channel(struct async_submit_ctl
						    *submit,
						    enum dma_transaction_type
						    tx_type);
extern void axera_async_tx_issue_pending_all(void);
#define async_tx_issue_pending_all axera_async_tx_issue_pending_all
...
#define async_tx_find_channel(dep, type, dst, dst_count, src, src_count, len) \
	 axera_async_tx_find_channel(dep, type)
#else //CONFIG_AXERA_ASYNC_TX_DMA
...
#endif /* CONFIG_AXERA_ASYNC_TX_DMA */
#else
