...
static int es7243l_set_dai_fmt(struct snd_soc_dai *dai, unsigned int fmt)
{
	...
	for (i = 0; i < (ES7243l_CHANNELS_MAX) / 2; i++) {
		...
		if ((es7243l->tdm != ES7243l_NORMAL_DSPB) && (es7243l->tdm != ES7243l_TDM_DSPB)) {
			/* clock inversion */
		      ...
		      struct snd_soc_dai *dai)
{
	...
	if (coeff >= 0) {
		for (index = 0; index < (ES7243l_CHANNELS_MAX) / 2; index++) {
			...
			es7243l_write(ES7243l_CLK_TRI,
					regv,
					i2c_clt[index]);
			es7243l_write(ES7243l_BCLK_DIV,
...
es7243l_adc1516_volume_set(struct snd_kcontrol *kcontrol,
		      struct snd_ctl_elem_value *ucontrol)
{
	es7243l_write(ES7243l_ADC_VOL, ucontrol->value.integer.value[7],
			i2c_clt[0]);
	return 0;
}
...
static const struct snd_soc_dapm_widget es7243l_dapm_widgets[] = {
	...
	SND_SOC_DAPM_AIF_OUT("SDOUT", "I2S Capture", NULL, SND_SOC_NOPM, 0, 0),
};
...
static int es7243l_probe(struct snd_soc_component *component)
{
	...
	for (index = 0; index < (ES7243l_CHANNELS_MAX) / 2; index++) {
		...
		es7243l_write(ES7243l_S1_SEL, 0xc5,
				i2c_clt[index]);
		es7243l_write(ES7243l_S3_SEL, 0x81,
				i2c_clt[index]);
...
es7243l_i2c_probe(struct i2c_client *i2c, const struct i2c_device_id *i2c_id)
{
	...
	if (i2c_id->driver_data < (ES7243l_CHANNELS_MAX) / 2) {
		...
		ret = snd_soc_register_component(&i2c->dev,
				&soc_component_dev_es7243l,
				es7243l_dai[i2c_id->driver_data], 1);
		if (ret < 0) {
			kfree(es7243l);
...
#if ES7243l_CHANNELS_MAX > 0
	{"es7243l_MicArray_0", 0},
#endif

#if ES7243l_CHANNELS_MAX > 2
	{"es7243l_MicArray_1", 1},
#endif

#if ES7243l_CHANNELS_MAX > 4
	{"es7243l_MicArray_2", 2},
#endif

#if ES7243l_CHANNELS_MAX > 6
	{"es7243l_MicArray_3", 3},
#endif

#if ES7243l_CHANNELS_MAX > 8
	{"es7243l_MicArray_4", 4},
#endif

#if ES7243l_CHANNELS_MAX > 10
	{"es7243l_MicArray_5", 5},
#endif

#if ES7243l_CHANNELS_MAX > 12
	{"es7243l_MicArray_6", 6},
#endif

#if ES7243l_CHANNELS_MAX > 14
	{"es7243l_MicArray_7", 7},
#endif
	{}
};
...
#if ES7243l_CHANNELS_MAX > 2
	{.compatible = "es7243l_MicArray_1",},
#endif

#if ES7243l_CHANNELS_MAX > 4
	{.compatible = "es7243l_MicArray_2",},
#endif

#if ES7243l_CHANNELS_MAX > 6
	{.compatible = "es7243l_MicArray_3",},
#endif

#if ES7243l_CHANNELS_MAX > 8
	{.compatible = "es7243l_MicArray_4",},
#endif

#if ES7243l_CHANNELS_MAX > 10
	{.compatible = "es7243l_MicArray_5",},
#endif

#if ES7243l_CHANNELS_MAX > 12
	{.compatible = "es7243l_MicArray_6",},
#endif

#if ES7243l_CHANNELS_MAX > 14
	{.compatible = "es7243l_MicArray_7",},
#endif
	{},
};
