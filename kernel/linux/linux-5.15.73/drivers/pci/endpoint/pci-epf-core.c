			...
			enum pci_epc_interface_type type)
{
	...
	epf_bar[bar].phys_addr -= epf_bar[bar].offset;
	addr -= epf_bar[bar].offset;
	epf_bar[bar].size = epf_bar[bar].real_size;
#endif
			  ...
			  size_t align, enum pci_epc_interface_type type)
{
	...
	dev = epc->dev.parent;
#ifdef CONFIG_PCIE_AXERA
	space = dma_alloc_coherent(dev, size + alignment, &org_phys_addr, GFP_KERNEL);
#else
...
#ifdef CONFIG_PCIE_AXERA
	epf_bar[bar].offset = offset;
	epf_bar[bar].real_size = size + alignment;
#endif
