...
s32 ax_os_release_reserved_mem(unsigned long phy_start, size_t size, const char *s)
{
	...
	ret = release_reserved_area_info(phy_start, phy_start + size);
	if (ret != 0) {
		pr_err("release reserved info error\n");
		return ret;
	}
...
static const struct proc_ops os_mem_stat_ops = {
	.proc_open = ax_os_mem_stat_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
	.proc_write = ax_os_mem_stat_write,
};
...
static const struct proc_ops os_mem_policy_ops = {
	.proc_open = ax_os_mem_policy_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
	.proc_write = ax_os_mem_policy_write,
};
...
static const struct proc_ops os_mem_max_disp_ops = {
	.proc_open = ax_os_mem_max_disp_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
	.proc_write = ax_os_mem_max_disp_write,
};
...
static const struct proc_ops os_mem_ctrl_ops = {
	.proc_open = ax_os_mem_ctrl_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
	.proc_write = ax_os_mem_ctrl_write,
};
