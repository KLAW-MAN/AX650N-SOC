...
typedef struct _PMU_SMB_LPDDR4_2D_t {
   u8  Reserved00;       // Byte offset 0x00, CSR Addr 0x54000, Direction=In
   ...
   u8  MsgMisc;          // Byte offset 0x01, CSR Addr 0x54000, Direction=In
   ...
   u16 PmuRevision;      // Byte offset 0x02, CSR Addr 0x54001, Direction=Out
                              // PMU firmware revision ID
                              // After training is run, this address will contain the revision ID of the firmware
   u8  Pstate;           // Byte offset 0x04, CSR Addr 0x54002, Direction=In
   ...
   u8  PllBypassEn;      // Byte offset 0x05, CSR Addr 0x54002, Direction=In
   ...
   u16 DRAMFreq;         // Byte offset 0x06, CSR Addr 0x54003, Direction=In
                              // DDR data rate for the target Pstate in units of MT/s.
                              // For example enter 0x0640 for DDR1600.
   u8  DfiFreqRatio;     // Byte offset 0x08, CSR Addr 0x54004, Direction=In
                              // Frequency ratio betwen DfiCtlClk and SDRAM memclk.
                              //    0x1 = 1:1
                              //    0x2 = 1:2
                              //    0x4 = 1:4
   u8  BPZNResVal ;      // Byte offset 0x09, CSR Addr 0x54004, Direction=In
                              ...
                              //
   u8  PhyOdtImpedance;  // Byte offset 0x0a, CSR Addr 0x54005, Direction=In
   ...
   u8  PhyDrvImpedance;  // Byte offset 0x0b, CSR Addr 0x54005, Direction=In
   ...
   u8  PhyVref;          // Byte offset 0x0c, CSR Addr 0x54006, Direction=In
   ...
   u8  Lp4Misc;          // Byte offset 0x0d, CSR Addr 0x54006, Direction=In
   ...
   u8  Reserved0E;       // Byte offset 0x0e, CSR Addr 0x54007, Direction=In
   ...
   u8  CsTestFail;       // Byte offset 0x0f, CSR Addr 0x54007, Direction=Out
                              // This field will be set if training fails on any rank.
                              //    0x0 = No failures
                              //    non-zero = one or more ranks failed training
   u16 SequenceCtrl;     // Byte offset 0x10, CSR Addr 0x54008, Direction=In
   ...
   u8  HdtCtrl;          // Byte offset 0x12, CSR Addr 0x54009, Direction=In
                              ...
                              //
   u8  Reserved13;       // Byte offset 0x13, CSR Addr 0x54009, Direction=In
                              //
                              // 0         = Default operation, unchanged.
                              // Others = RD DQ calibration Training steps are completed with user specified pattern.
   u8  Reserved14;       // Byte offset 0x14, CSR Addr 0x5400a, Direction=In
   ...
   u8  Reserved15;       // Byte offset 0x15, CSR Addr 0x5400a, Direction=In
   ...
   u8  DFIMRLMargin;     // Byte offset 0x16, CSR Addr 0x5400b, Direction=In
   ...
   u8  Reserved17;       // Byte offset 0x17, CSR Addr 0x5400b, Direction=In
   ...
   u8  UseBroadcastMR;   // Byte offset 0x18, CSR Addr 0x5400c, Direction=In
                              ...
                              //
   u8  Reserved19;     // Byte offset 0x19, CSR Addr 0x5400c, Direction=N/A

   u8  Reserved1A;       // Byte offset 0x1a, CSR Addr 0x5400d, Direction=In
   ...
   u8  CATrainOpt;       // Byte offset 0x1b, CSR Addr 0x5400d, Direction=In
   ...
   u8  X8Mode;           // Byte offset 0x1c, CSR Addr 0x5400e, Direction=In
                              // X8 mode configuration:
                              // 0x0 = x16 configuration for all devices
                              // 0xF =  x8 configuration for all devices
                              // All other values are RFU
   u8  RX2D_TrainOpt;    // Byte offset 0x1d, CSR Addr 0x5400e, Direction=In
                              ...
                              //
   u8  TX2D_TrainOpt;    // Byte offset 0x1e, CSR Addr 0x5400f, Direction=In
                              ...
                              // [5-7] RFU, must be zero
                              //
   u8  Share2DVrefResult; // Byte offset 0x1f, CSR Addr 0x5400f, Direction=In
   ...
   u8  Delay_Weight2D;   // Byte offset 0x20, CSR Addr 0x54010, Direction=In
   ...
   u8  Voltage_Weight2D; // Byte offset 0x21, CSR Addr 0x54010, Direction=In
   ...
   u16 PhyConfigOverride; // Byte offset 0x22, CSR Addr 0x54011, Direction=In
                              ...
                              //
   u8  EnabledDQsChA;    // Byte offset 0x24, CSR Addr 0x54012, Direction=In
                              // Total number of DQ bits enabled in PHY Channel A
   u8  CsPresentChA;     // Byte offset 0x25, CSR Addr 0x54012, Direction=In
                              ...
                              //
   u8   CDD_ChA_RR_1_0;   // Byte offset 0x26, CSR Addr 0x54013, Direction=Out
   ...
   u8  VrefDac_Margin_A0; // Byte offset 0x50, CSR Addr 0x54028, Direction=Out
   ...
   u8  TxDqDly_Margin_A0; // Byte offset 0x51, CSR Addr 0x54028, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   u8  DeviceVref_Margin_A0; // Byte offset 0x52, CSR Addr 0x54029, Direction=Out
   ...
   u8  RxClkDly_Margin_A1; // Byte offset 0x53, CSR Addr 0x54029, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   u8  VrefDac_Margin_A1; // Byte offset 0x54, CSR Addr 0x5402a, Direction=Out
                              // Distance from the trained center to the closest failing region in phy DAC steps. This value is the minimum of all eyes in this timing group.
   u8  TxDqDly_Margin_A1; // Byte offset 0x55, CSR Addr 0x5402a, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   u8  DeviceVref_Margin_A1; // Byte offset 0x56, CSR Addr 0x5402b, Direction=Out
                              // Distance from the trained center to the closest failing region in device DAC steps. This value is the minimum of all eyes in this timing group.
   u8  EnabledDQsChB;    // Byte offset 0x57, CSR Addr 0x5402b, Direction=In
                              // Total number of DQ bits enabled in PHY Channel B
   u8  CsPresentChB;     // Byte offset 0x58, CSR Addr 0x5402c, Direction=In
                              ...
                              // All other encodings are illegal
                              //
   u8   CDD_ChB_RR_1_0;   // Byte offset 0x59, CSR Addr 0x5402c, Direction=Out
                              // This is a signed integer value.
                              // Read to read critical delay difference from cs 1 to cs 0 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   u8   CDD_ChB_RR_0_1;   // Byte offset 0x5a, CSR Addr 0x5402d, Direction=Out
                              // This is a signed integer value.
                              // Read to read critical delay difference from cs 0 to cs 1 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   u8   CDD_ChB_RW_1_1;   // Byte offset 0x5b, CSR Addr 0x5402d, Direction=Out
                              // This is a signed integer value.
                              // Read to write critical delay difference from cs 1 to cs 1 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   u8   CDD_ChB_RW_1_0;   // Byte offset 0x5c, CSR Addr 0x5402e, Direction=Out
                              // This is a signed integer value.
                              // Read to write critical delay difference from cs 1 to cs 0 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   u8   CDD_ChB_RW_0_1;   // Byte offset 0x5d, CSR Addr 0x5402e, Direction=Out
                              // This is a signed integer value.
                              // Read to write critical delay difference from cs 0 to cs 1 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   u8   CDD_ChB_RW_0_0;   // Byte offset 0x5e, CSR Addr 0x5402f, Direction=Out
                              // This is a signed integer value.
                              // Read to write critical delay difference from cs01 to cs 0 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   u8   CDD_ChB_WR_1_1;   // Byte offset 0x5f, CSR Addr 0x5402f, Direction=Out
                              // This is a signed integer value.
                              // Write  to read critical delay difference from cs 1 to cs 1 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   u8   CDD_ChB_WR_1_0;   // Byte offset 0x60, CSR Addr 0x54030, Direction=Out
                              // This is a signed integer value.
                              // Write  to read critical delay difference from cs 1 to cs 0 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   u8   CDD_ChB_WR_0_1;   // Byte offset 0x61, CSR Addr 0x54030, Direction=Out
                              // This is a signed integer value.
                              // Write  to read critical delay difference from cs 0 to cs 1 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   u8   CDD_ChB_WR_0_0;   // Byte offset 0x62, CSR Addr 0x54031, Direction=Out
                              // This is a signed integer value.
                              // Write  to read critical delay difference from cs 0 to cs 0 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   u8   CDD_ChB_WW_1_0;   // Byte offset 0x63, CSR Addr 0x54031, Direction=Out
                              // This is a signed integer value.
                              // Write  to write critical delay difference from cs 1 to cs 0 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   u8   CDD_ChB_WW_0_1;   // Byte offset 0x64, CSR Addr 0x54032, Direction=Out
                              // This is a signed integer value.
                              // Write  to write critical delay difference from cs 0 to cs 1 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   u8  MR1_B0;           // Byte offset 0x65, CSR Addr 0x54032, Direction=In
                              // Value to be programmed in DRAM Mode Register 1 {Channel B, Rank 0}
   u8  MR2_B0;           // Byte offset 0x66, CSR Addr 0x54033, Direction=In
                              // Value to be programmed in DRAM Mode Register 2 {Channel B, Rank 0}
   u8  MR3_B0;           // Byte offset 0x67, CSR Addr 0x54033, Direction=In
                              // Value to be programmed in DRAM Mode Register 3 {Channel B, Rank 0}
   u8  MR4_B0;           // Byte offset 0x68, CSR Addr 0x54034, Direction=In
                              // Value to be programmed in DRAM Mode Register 4 {Channel B, Rank 0}
   u8  MR11_B0;          // Byte offset 0x69, CSR Addr 0x54034, Direction=In
                              // Value to be programmed in DRAM Mode Register 11 {Channel B, Rank 0}
   u8  MR12_B0;          // Byte offset 0x6a, CSR Addr 0x54035, Direction=In
                              // Value to be programmed in DRAM Mode Register 12 {Channel B, Rank 0}
   u8  MR13_B0;          // Byte offset 0x6b, CSR Addr 0x54035, Direction=In
                              // Value to be programmed in DRAM Mode Register 13 {Channel B, Rank 0}
   u8  MR14_B0;          // Byte offset 0x6c, CSR Addr 0x54036, Direction=In
                              // Value to be programmed in DRAM Mode Register 14 {Channel B, Rank 0}
   u8  MR16_B0;          // Byte offset 0x6d, CSR Addr 0x54036, Direction=In
                              // Value to be programmed in DRAM Mode Register 16 {Channel B, Rank 0}
   u8  MR17_B0;          // Byte offset 0x6e, CSR Addr 0x54037, Direction=In
                              // Value to be programmed in DRAM Mode Register 17 {Channel B, Rank 0}
   u8  MR22_B0;          // Byte offset 0x6f, CSR Addr 0x54037, Direction=In
                              // Value to be programmed in DRAM Mode Register 22 {Channel B, Rank 0}
   u8  MR24_B0;          // Byte offset 0x70, CSR Addr 0x54038, Direction=In
                              // Value to be programmed in DRAM Mode Register 24 {Channel B, Rank 0}
   u8  MR1_B1;           // Byte offset 0x71, CSR Addr 0x54038, Direction=In
                              // Value to be programmed in DRAM Mode Register 1 {Channel B, Rank 1}
   u8  MR2_B1;           // Byte offset 0x72, CSR Addr 0x54039, Direction=In
                              // Value to be programmed in DRAM Mode Register 2 {Channel B, Rank 1}
   u8  MR3_B1;           // Byte offset 0x73, CSR Addr 0x54039, Direction=In
                              // Value to be programmed in DRAM Mode Register 3 {Channel B, Rank 1}
   u8  MR4_B1;           // Byte offset 0x74, CSR Addr 0x5403a, Direction=In
                              // Value to be programmed in DRAM Mode Register 4 {Channel B, Rank 1}
   u8  MR11_B1;          // Byte offset 0x75, CSR Addr 0x5403a, Direction=In
                              // Value to be programmed in DRAM Mode Register 11 {Channel B, Rank 1}
   u8  MR12_B1;          // Byte offset 0x76, CSR Addr 0x5403b, Direction=In
                              // Value to be programmed in DRAM Mode Register 12 {Channel B, Rank 1}
   u8  MR13_B1;          // Byte offset 0x77, CSR Addr 0x5403b, Direction=In
                              // Value to be programmed in DRAM Mode Register 13 {Channel B, Rank 1}
   u8  MR14_B1;          // Byte offset 0x78, CSR Addr 0x5403c, Direction=In
                              // Value to be programmed in DRAM Mode Register 14 {Channel B, Rank 1}
   u8  MR16_B1;          // Byte offset 0x79, CSR Addr 0x5403c, Direction=In
                              // Value to be programmed in DRAM Mode Register 16 {Channel B, Rank 1}
   u8  MR17_B1;          // Byte offset 0x7a, CSR Addr 0x5403d, Direction=In
                              // Value to be programmed in DRAM Mode Register 17 {Channel B, Rank 1}
   u8  MR22_B1;          // Byte offset 0x7b, CSR Addr 0x5403d, Direction=In
                              // Value to be programmed in DRAM Mode Register 22 {Channel B, Rank 1}
   u8  MR24_B1;          // Byte offset 0x7c, CSR Addr 0x5403e, Direction=In
                              // Value to be programmed in DRAM Mode Register 24 {Channel B, Rank 1}
   u8  CATerminatingRankChB; // Byte offset 0x7d, CSR Addr 0x5403e, Direction=In
                              // Terminating Rank for CA bus on Channel B
                              //    0x0 = Rank 0 is terminating rank
                              //    0x1 = Rank 1 is terminating rank
   u8  Reserved7E; // Byte offset 0x7e, CSR Addr 0x5403f, Direction=N/A

   u8  Reserved7F; // Byte offset 0x7f, CSR Addr 0x5403f, Direction=N/A

   u8  TrainedVREFDQ_B0; // Byte offset 0x80, CSR Addr 0x54040, Direction=Out
                              // Trained DQ Vref setting for Ch B Rank 0
   u8  TrainedVREFDQ_B1; // Byte offset 0x81, CSR Addr 0x54040, Direction=Out
                              // Trained DQ Vref setting for Ch B Rank 1
   u8  RxClkDly_Margin_B0; // Byte offset 0x82, CSR Addr 0x54041, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   u8  VrefDac_Margin_B0; // Byte offset 0x83, CSR Addr 0x54041, Direction=Out
                              // Distance from the trained center to the closest failing region in phy DAC steps. This value is the minimum of all eyes in this timing group.
   u8  TxDqDly_Margin_B0; // Byte offset 0x84, CSR Addr 0x54042, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   u8  DeviceVref_Margin_B0; // Byte offset 0x85, CSR Addr 0x54042, Direction=Out
                              // Distance from the trained center to the closest failing region in device DAC steps. This value is the minimum of all eyes in this timing group.
   u8  RxClkDly_Margin_B1; // Byte offset 0x86, CSR Addr 0x54043, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   u8  VrefDac_Margin_B1; // Byte offset 0x87, CSR Addr 0x54043, Direction=Out
                              // Distance from the trained center to the closest failing region in phy DAC steps. This value is the minimum of all eyes in this timing group.
   u8  TxDqDly_Margin_B1; // Byte offset 0x88, CSR Addr 0x54044, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   u8  DeviceVref_Margin_B1; // Byte offset 0x89, CSR Addr 0x54044, Direction=Out
                              // Distance from the trained center to the closest failing region in device DAC steps. This value is the minimum of all eyes in this timing group.
} __attribute__ ((packed)) PMU_SMB_LPDDR4X_2D_t;
