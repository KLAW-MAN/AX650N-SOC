...
typedef struct _PMU_SMB_LPDDR4_1D_t {
   ...
   u8  UseBroadcastMR;   // Byte offset 0x18, CSR Addr 0x5400c, Direction=In
                              ...
                              //
   u8  Lp4Quickboot;     // Byte offset 0x19, CSR Addr 0x5400c, Direction=In
                              // Enable Quickboot.
   ...
   u8  Reserved1D;    // Byte offset 0x1d, CSR Addr 0x5400e, Direction=N/A
   ...
   u8  Reserved1E;    // Byte offset 0x1e, CSR Addr 0x5400f, Direction=N/A
   ...
   u8  Reserved20;   // Byte offset 0x20, CSR Addr 0x54010, Direction=N/A

   u8  Reserved21; // Byte offset 0x21, CSR Addr 0x54010, Direction=N/A
   ...
   u8  Reserved4D; // Byte offset 0x4d, CSR Addr 0x54026, Direction=N/A

   u8  Reserved4E; // Byte offset 0x4e, CSR Addr 0x54027, Direction=N/A

   u8  Reserved4F; // Byte offset 0x4f, CSR Addr 0x54027, Direction=N/A

   u8  Reserved50; // Byte offset 0x50, CSR Addr 0x54028, Direction=N/A

   u8  Reserved51; // Byte offset 0x51, CSR Addr 0x54028, Direction=N/A

   u8  Reserved52; // Byte offset 0x52, CSR Addr 0x54029, Direction=N/A

   u8  Reserved53; // Byte offset 0x53, CSR Addr 0x54029, Direction=N/A

   u8  Reserved54; // Byte offset 0x54, CSR Addr 0x5402a, Direction=N/A

   u8  Reserved55; // Byte offset 0x55, CSR Addr 0x5402a, Direction=N/A

   u8  Reserved56; // Byte offset 0x56, CSR Addr 0x5402b, Direction=N/A
   ...
   u8  Reserved80; // Byte offset 0x80, CSR Addr 0x54040, Direction=N/A

   u8  Reserved81; // Byte offset 0x81, CSR Addr 0x54040, Direction=N/A

   u8  Reserved82; // Byte offset 0x82, CSR Addr 0x54041, Direction=N/A

   u8  Reserved83; // Byte offset 0x83, CSR Addr 0x54041, Direction=N/A

   u8  Reserved84; // Byte offset 0x84, CSR Addr 0x54042, Direction=N/A

   u8  Reserved85; // Byte offset 0x85, CSR Addr 0x54042, Direction=N/A

   u8  Reserved86; // Byte offset 0x86, CSR Addr 0x54043, Direction=N/A

   u8  Reserved87; // Byte offset 0x87, CSR Addr 0x54043, Direction=N/A

   u8  Reserved88; // Byte offset 0x88, CSR Addr 0x54044, Direction=N/A

   u8  Reserved89; // Byte offset 0x89, CSR Addr 0x54044, Direction=N/A
