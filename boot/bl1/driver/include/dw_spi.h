...
#define SFC_CLK					0x54
#define SFC_MOSI_IO0			0x6c
#define SFC_MISO_IO1			0x78
#define SFC_WP_IO2				0x84
#define SFC_HOLD_IO3			0x90
#define SFC_CSN0				0x60
#define SFC_CSN1				0x48

//SPI slave pin config reg(pin G7)
#define SPI_D3_S				0x0c
#define SPI_D2_S				0x18
#define SPI_CLK_S				0x24
#define SPI_CS_S				0x30
#define SPI_D1_S				0x3c
#define SPI_D0_S				0x48

//GPIO0 pin config reg(pin G3)
#define FLASH_EN				0x114

#define DW_SPI_BASE				0x20000000
#define DW_SPI_SLAVE_BASE		0x499e000
...
#define SPI_SLV_DMA_TXRX_DLR	32
...
#if defined (RTL09_TAG0115) || defined (RTL09_TAG0311)
#define CURR_CS				1 //nand & nor both use cs0 in formal version
#define SPI_CS_GPIO(x)			((x) > 0 ? (1 << 1) : (1 << 0))
#else
#define CURR_CS				4 //nand & nor both use cs0 in formal version
#define SPI_CS_GPIO(x)			(BIT(x))
#endif
