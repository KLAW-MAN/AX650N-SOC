...
#define FLASH_SYS_RTC_PINMUX_CFG_SET    (FLASH_SYS_GLB + 0x103C)
#define FLASH_SYS_RTC_PINMUX_CFG_OFFSET (8)
...
#define LANEN_DIG_RX_OVRD_IN_HI_OFFS                           (0x1006 * 4)
#define LANEN_DIG_RX_OVRD_IN_HI_RX_EQ_OVRD_LSB                 11
#define LANEN_DIG_RX_OVRD_IN_HI_RX_EQ_LSB                      8
#define LANEN_DIG_RX_OVRD_IN_HI_RX_EQ_EN_OVRD_LSB              7
#define LANEN_DIG_RX_OVRD_IN_HI_RX_EQ_EN_LSB                   6

#define PIPEPHY_GLB                                            0x30700000
#define PIPE_PHY_GLB_PCS_CTL0_0_ADDR                           (PIPEPHY_GLB + 0x10)
#define PIPE_PHY_GLB_PCS_CTL0_1_ADDR                           (PIPEPHY_GLB + 0x14)
#define PIPE_PHY_GLB_PCS_CTL0_2_ADDR                           (PIPEPHY_GLB + 0x18)
#define PIPE_PHY_GLB_PCS_CTL0_3_ADDR                           (PIPEPHY_GLB + 0x1C)
#define PIPE_PHY_GLB_PCS_CTL0_4_ADDR                           (PIPEPHY_GLB + 0x20)
#define PIPE_PHY_GLB_PCS_CTL0_5_ADDR                           (PIPEPHY_GLB + 0x24)
#define PIPE_PHY_GLB_PCS_CTL0_6_ADDR                           (PIPEPHY_GLB + 0x28)
#define PIPE_PHY_GLB_PCS_CTL0_7_ADDR                           (PIPEPHY_GLB + 0x2C)
#define PIPE_PHY_GLB_PCS_CTL0_8_ADDR                           (PIPEPHY_GLB + 0x30)
#define PIPE_PHY_GLB_PCS_CTL1_0_ADDR                           (PIPEPHY_GLB + 0x34)
#define PIPE_PHY_GLB_PCS_CTL1_1_ADDR                           (PIPEPHY_GLB + 0x38)
#define PIPE_PHY_GLB_PCS_CTL1_2_ADDR                           (PIPEPHY_GLB + 0x3C)
#define PIPE_PHY_GLB_PCS_CTL1_3_ADDR                           (PIPEPHY_GLB + 0x40)
#define PIPE_PHY_GLB_PCS_CTL1_4_ADDR                           (PIPEPHY_GLB + 0x44)
#define PIPE_PHY_GLB_PCS_CTL1_5_ADDR                           (PIPEPHY_GLB + 0x48)
#define PIPE_PHY_GLB_PCS_CTL1_6_ADDR                           (PIPEPHY_GLB + 0x4C)
#define PIPE_PHY_GLB_PCS_CTL1_7_ADDR                           (PIPEPHY_GLB + 0x50)
#define PIPE_PHY_GLB_PCS_CTL1_8_ADDR                           (PIPEPHY_GLB + 0x54)
#define PIPE_PHY_GLB_PCS_CTL0_0_SET_ADDR                       (PIPEPHY_GLB + 0x1010)
#define PIPE_PHY_GLB_PCS_CTL0_1_SET_ADDR                       (PIPEPHY_GLB + 0x1014)
...
#define PIPE_PHY_GLB_PCS_CTL0_5_SET_ADDR                       (PIPEPHY_GLB + 0x1024)
#define PIPE_PHY_GLB_PCS_CTL0_6_SET_ADDR                       (PIPEPHY_GLB + 0x1028)
#define PIPE_PHY_GLB_PCS_CTL0_7_SET_ADDR                       (PIPEPHY_GLB + 0x102C)
#define PIPE_PHY_GLB_PCS_CTL0_8_SET_ADDR                       (PIPEPHY_GLB + 0x1030)
#define PIPE_PHY_GLB_PCS_CTL1_0_SET_ADDR                       (PIPEPHY_GLB + 0x1034)
#define PIPE_PHY_GLB_PCS_CTL1_1_SET_ADDR                       (PIPEPHY_GLB + 0x1038)
...
#define PIPE_PHY_GLB_PCS_CTL1_5_SET_ADDR                       (PIPEPHY_GLB + 0x1048)
#define PIPE_PHY_GLB_PCS_CTL1_6_SET_ADDR                       (PIPEPHY_GLB + 0x104C)
#define PIPE_PHY_GLB_PCS_CTL1_7_SET_ADDR                       (PIPEPHY_GLB + 0x1050)
#define PIPE_PHY_GLB_PCS_CTL1_8_SET_ADDR                       (PIPEPHY_GLB + 0x1054)
#define PIPE_PHY_GLB_PCS_CTL0_1_CLR_ADDR                       (PIPEPHY_GLB + 0x2014)
#define PIPE_PHY_GLB_PCS_CTL0_2_CLR_ADDR                       (PIPEPHY_GLB + 0x2018)
#define PIPE_PHY_GLB_PCS_CTL0_3_CLR_ADDR                       (PIPEPHY_GLB + 0x201C)
#define PIPE_PHY_GLB_PCS_CTL0_4_CLR_ADDR                       (PIPEPHY_GLB + 0x2020)
#define PIPE_PHY_GLB_PCS_CTL0_5_CLR_ADDR                       (PIPEPHY_GLB + 0x2024)
#define PIPE_PHY_GLB_PCS_CTL0_6_CLR_ADDR                       (PIPEPHY_GLB + 0x2028)
#define PIPE_PHY_GLB_PCS_CTL0_7_CLR_ADDR                       (PIPEPHY_GLB + 0x202C)
#define PIPE_PHY_GLB_PCS_CTL0_8_CLR_ADDR                       (PIPEPHY_GLB + 0x2030)
#define PIPE_PHY_GLB_PCS_CTL1_1_CLR_ADDR                       (PIPEPHY_GLB + 0x2038)
#define PIPE_PHY_GLB_PCS_CTL1_2_CLR_ADDR                       (PIPEPHY_GLB + 0x203C)
#define PIPE_PHY_GLB_PCS_CTL1_3_CLR_ADDR                       (PIPEPHY_GLB + 0x2040)
#define PIPE_PHY_GLB_PCS_CTL1_4_CLR_ADDR                       (PIPEPHY_GLB + 0x2044)
#define PIPE_PHY_GLB_PCS_CTL1_5_CLR_ADDR                       (PIPEPHY_GLB + 0x2048)
#define PIPE_PHY_GLB_PCS_CTL1_6_CLR_ADDR                       (PIPEPHY_GLB + 0x204C)
#define PIPE_PHY_GLB_PCS_CTL1_7_CLR_ADDR                       (PIPEPHY_GLB + 0x2050)
#define PIPE_PHY_GLB_PCS_CTL1_8_CLR_ADDR                       (PIPEPHY_GLB + 0x2054)
#define PIPE_PHY_GLB_PCS_CTL0_1_PCS_TX_DEEMPH_GEN3_6DB_LSB     14
#define PIPE_PHY_GLB_PCS_CTL0_1_PCS_TX_DEEMPH_GEN2_3P5DB_LSB   20
#define PIPE_PHY_GLB_PCS_CTL0_1_PCS_TX_DEEMPH_GEN1_LSB         26
#define PIPE_PHY_GLB_PCS_CTL1_1_PCS_TX_DEEMPH_GEN3_6DB_LSB     14
#define PIPE_PHY_GLB_PCS_CTL1_1_PCS_TX_DEEMPH_GEN2_3P5DB_LSB   20
#define PIPE_PHY_GLB_PCS_CTL1_1_PCS_TX_DEEMPH_GEN1_LSB         26
#define PIPE_PHY_GLB_PCS_CTL0_2_PHY0_CSR_TX_VBOOST_LVL_LSB     1
#define PIPE_PHY_GLB_PCS_CTL0_3_PHY1_CSR_TX_VBOOST_LVL_LSB     1
#define PIPE_PHY_GLB_PCS_CTL1_2_PHY0_CSR_TX_VBOOST_LVL_LSB     1
#define PIPE_PHY_GLB_PCS_CTL1_3_PHY1_CSR_TX_VBOOST_LVL_LSB     1
...
#define PIPE_PHY_GLB_PCS_CTL0_2_PHY0_CSR_LOS_BIAS_LSB          21
#define PIPE_PHY_GLB_PCS_CTL0_3_PHY1_CSR_LOS_BIAS_LSB          21
#define PIPE_PHY_GLB_PCS_CTL1_2_PHY0_CSR_LOS_BIAS_LSB          21
#define PIPE_PHY_GLB_PCS_CTL1_3_PHY1_CSR_LOS_BIAS_LSB          21
...
#define PIPE_PHY_GLB_PCS_CTL0_5_SATA0_P0_TX_AMPLITUDE_GEN1_LSB 14
#define PIPE_PHY_GLB_PCS_CTL0_5_SATA0_P0_TX_AMPLITUDE_GEN2_LSB 7
#define PIPE_PHY_GLB_PCS_CTL0_5_SATA0_P0_TX_AMPLITUDE_GEN3_LSB 0
#define PIPE_PHY_GLB_PCS_CTL0_6_SATA0_P0_TX_PREEMPH_GEN1_LSB   12
#define PIPE_PHY_GLB_PCS_CTL0_6_SATA0_P0_TX_PREEMPH_GEN2_LSB   6
#define PIPE_PHY_GLB_PCS_CTL0_6_SATA0_P0_TX_PREEMPH_GEN3_LSB   0
#define PIPE_PHY_GLB_PCS_CTL0_7_SATA1_P0_TX_AMPLITUDE_GEN1_LSB 14
#define PIPE_PHY_GLB_PCS_CTL0_7_SATA1_P0_TX_AMPLITUDE_GEN2_LSB 7
#define PIPE_PHY_GLB_PCS_CTL0_7_SATA1_P0_TX_AMPLITUDE_GEN3_LSB 0
#define PIPE_PHY_GLB_PCS_CTL0_8_SATA1_P0_TX_PREEMPH_GEN1_LSB   12
#define PIPE_PHY_GLB_PCS_CTL0_8_SATA1_P0_TX_PREEMPH_GEN2_LSB   6
#define PIPE_PHY_GLB_PCS_CTL0_8_SATA1_P0_TX_PREEMPH_GEN3_LSB   0
#define PIPE_PHY_GLB_PCS_CTL1_5_SATA0_P0_TX_AMPLITUDE_GEN1_LSB 14
#define PIPE_PHY_GLB_PCS_CTL1_5_SATA0_P0_TX_AMPLITUDE_GEN2_LSB 7
#define PIPE_PHY_GLB_PCS_CTL1_5_SATA0_P0_TX_AMPLITUDE_GEN3_LSB 0
#define PIPE_PHY_GLB_PCS_CTL1_6_SATA0_P0_TX_PREEMPH_GEN1_LSB   12
#define PIPE_PHY_GLB_PCS_CTL1_6_SATA0_P0_TX_PREEMPH_GEN2_LSB   6
#define PIPE_PHY_GLB_PCS_CTL1_6_SATA0_P0_TX_PREEMPH_GEN3_LSB   0
#define PIPE_PHY_GLB_PCS_CTL1_7_SATA1_P0_TX_AMPLITUDE_GEN1_LSB 14
#define PIPE_PHY_GLB_PCS_CTL1_7_SATA1_P0_TX_AMPLITUDE_GEN2_LSB 7
#define PIPE_PHY_GLB_PCS_CTL1_7_SATA1_P0_TX_AMPLITUDE_GEN3_LSB 0
#define PIPE_PHY_GLB_PCS_CTL1_8_SATA1_P0_TX_PREEMPH_GEN1_LSB   12
#define PIPE_PHY_GLB_PCS_CTL1_8_SATA1_P0_TX_PREEMPH_GEN2_LSB   6
#define PIPE_PHY_GLB_PCS_CTL1_8_SATA1_P0_TX_PREEMPH_GEN3_LSB   0
...
#define RTC_SYS_GLB                     0x285FD000
#define RTC_SYS_GLB_MASK                0xFFFFF000
#define RTC_SYS_GLB_FUNC                0x1B0
#define RTC_SYS_PROPERTY_DEF            0x3
#define RTC_SYS_PWD                     (RTC_SYS_GLB)
#define RTC_PWD                         (0x61696370)
