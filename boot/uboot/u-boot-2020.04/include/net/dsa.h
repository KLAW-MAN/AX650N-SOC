...
#define ofnode_is_enabled ofnode_is_available
#define dev_get_parent_plat dev_get_parent_platdata
#define dev_get_uclass_plat dev_get_uclass_platdata
#define dev_get_plat dev_get_platdata
