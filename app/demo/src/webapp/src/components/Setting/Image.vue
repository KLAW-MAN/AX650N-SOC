<template>
  <div>
    <el-form ref="formImageRef" :rules="formImageRules" :model="formImage" label-width="160px" size="mini">
      <el-form-item label="Camera:">
        <el-select v-model="formImage.src_id" @change="onChangeSrcID" :disabled="img_multi_mode == 0">
          <el-option v-for="item in Array.from({ length: setting_sns_count }, (item, index) => index)" :key="item" :label="'' + item"
            :value="item"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="Image Attr.:">
      ...
      <el-form-item label="" label-width="90px">
          <el-form-item label="Brightness:" class="inline" v-show="formImage.image_attr.isp_auto_mode === 0">
          ...
          <el-form-item label="Saturation:" class="inline" v-show="formImage.image_attr.isp_auto_mode === 0">
            <el-slider v-model="formImage.image_attr.saturation_val" :min="0" :max="100" :show-tooltip="false" show-input
              @change="onChangeImgAttrValue"  size="mini"></el-slider>
          </el-form-item>
          <el-form-item label="Contrast:" class="inline" v-show="formImage.image_attr.isp_auto_mode === 0">
            <el-slider v-model="formImage.image_attr.contrast_val" :min="0" :max="100" :show-tooltip="false" show-input
              @change="onChangeImgAttrValue"  size="mini"></el-slider>
          </el-form-item>
          <el-form-item label="Sharpness:" class="inline" v-show="formImage.image_attr.isp_auto_mode === 0">
            <el-slider v-model="formImage.image_attr.sharpness_val" :min="0" :max="100" :show-tooltip="false" show-input
              @change="onChangeImgAttrValue"  size="mini"></el-slider>
          </el-form-item>
      </el-form-item>
      <el-form-item label="LDC:" v-show="formImage.ldc_attr.ldc_support">
        <el-switch v-model="formImage.ldc_attr.ldc_enable"></el-switch>
      </el-form-item>
      <el-form-item label="" label-width="90px">
          <el-form-item label="Keep Aspect Ratio:" class="inline" v-show="formImage.ldc_attr.ldc_support && formImage.ldc_attr.ldc_enable">
            <el-switch v-model="formImage.ldc_attr.aspect"></el-switch>
          </el-form-item>
          <el-form-item label="X Ratio:" class="inline" v-show="formImage.ldc_attr.ldc_support && formImage.ldc_attr.ldc_enable && !formImage.ldc_attr.aspect">
            <el-slider v-model="formImage.ldc_attr.x_ratio" :min="0" :max="100" :show-tooltip="false" show-input
              @change="onChangeImgAttrValue"  size="mini"></el-slider>
          </el-form-item>
          <el-form-item label="Y Ratio:" class="inline" v-show="formImage.ldc_attr.ldc_support && formImage.ldc_attr.ldc_enable && !formImage.ldc_attr.aspect">
            <el-slider v-model="formImage.ldc_attr.y_ratio" :min="0" :max="100" :show-tooltip="false" show-input
              @change="onChangeImgAttrValue"  size="mini"></el-slider>
          </el-form-item>
          <el-form-item label="XY Ratio:" class="inline" v-show="formImage.ldc_attr.ldc_support && formImage.ldc_attr.ldc_enable && formImage.ldc_attr.aspect">
            <el-slider v-model="formImage.ldc_attr.xy_ratio" :min="0" :max="100" :show-tooltip="false" show-input
              @change="onChangeImgAttrValue"  size="mini"></el-slider>
          </el-form-item>
          <el-form-item label="Distortion Ratio:" class="inline" v-show="formImage.ldc_attr.ldc_support && formImage.ldc_attr.ldc_enable">
...
<script>
export default {
  props: ["img_multi_mode", "setting_sns_count"],
  data() {
    return {
      isp_mode: [
        {
