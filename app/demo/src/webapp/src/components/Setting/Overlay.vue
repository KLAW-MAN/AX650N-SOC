  ...
  <div>
    <el-container>
        ...
        <el-aside class="preview_container" width="600px">
          <div class="videoContainer" id="videoContainer">
            <div id="osdVideo" class="osdVideo" ref="osdVideoRef">
              <video id="myVideo" v-show="this.showVideo"  ref="frtVideoRef" class="frtVideo" autoplay muted playsinline oncontextmenu="return false;">
              </video>
              <canvas id="myMjpeg" width="600px" height="400px" v-show="!!!this.showVideo" class="frtVideoMJpeg">
              </canvas>
            </div>
          ...
          <div>
            <el-form label-width="88px">
              <el-form-item label="Camera:">
                <el-select class="Camera" v-model="formOverlay.src_id" size="mini" @change="onChangeSrcID" :disabled="setting_sns_count == 1">
            ...
            <el-tabs tab-position="left" style="height: 200px;">
              ...
              <el-tab-pane label="Position Title">
                <el-form ref="formOverlayRef" :rules="formOverlayRules" :model="formOverlay.overlay_attr[chn_cur]" label-width="100px">
                  <el-form-item label="Display:">
              ...
              <el-tab-pane label="Channel Title">
                <el-form ref="formOverlayRef" :rules="formOverlayRules" :model="formOverlay.overlay_attr[chn_cur]" label-width="100px">
                  <el-form-item label="Display:">
              ...
              <el-tab-pane label="Private Mask">
                <el-form ref="formOverlayRef" :rules="formOverlayRules" :model="formOverlay.overlay_attr[chn_cur]" label-width="100px" :disabled="!this.privacySupport">
                  <el-form-item label="Display:">
                  ...
                  <el-form-item label="Line Width:" v-show="formOverlay.privacy_attr.type != OSD_PRIVACY_TYPE_MOSA">
                  ...
                  <el-form-item label="Size:" v-show="formOverlay.privacy_attr.type == OSD_PRIVACY_TYPE_MOSA">
                    <el-select v-model="formOverlay.privacy_attr.linewidth" size="mini" :disabled="!formOverlay.privacy_attr.enable">
                      <el-option v-for="item in Array.from({ length: 5 }, (item, index) => index + 1)" :key="item" :label="'' + item" :value="item"> </el-option>
                    </el-select>
                  </el-form-item>
                  <el-form-item label="Color:" v-show="formOverlay.privacy_attr.type != OSD_PRIVACY_TYPE_MOSA">
                    <el-select v-model="formOverlay.privacy_attr.color" size="mini" :disabled="!formOverlay.privacy_attr.enable">
                      <el-option v-for="item in colorOptions" :key="item.label" :label="item.label" :value="item.value"> </el-option>
                    </el-select>
                  </el-form-item>
                  <el-form-item label="Fill:" v-show="formOverlay.privacy_attr.type != OSD_PRIVACY_TYPE_MOSA">
      ...
      <el-footer class="overlayFooter">
        ...
        <el-button type="primary" @click="onFresh" size="mini">Refresh</el-button>
      </el-footer>
    </el-container>
  </div>
</template>
  ...
  methods: {
    ...
    async getInfo() {
      ...
      try {
        ...
        if (res.meta.status === 200) {
          ...
          if ("privacy_attr" in res.data) {
            this.formOverlay.privacy_attr = res.data.privacy_attr
          } else {
            this.privacySupport = false
          }
    ...
    async changeStream(value, replay = true, changeData = true) {
      ...
      if (!res || res.meta.status !== 200) {
        return this.$message.error('change stream failed')
      }
      if (changeData) {
    ...
    async getVideoInfo() {
      try {
        ...
        if (res.meta.status === 200) {
          ...
          /* stream capability(multi sensor) */
