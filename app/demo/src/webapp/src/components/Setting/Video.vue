    ...
    <div>
      <el-form ref="formVideoRef" :rules="formVideoRules" :model="formVideo" label-width="110px" size="mini">
        <el-form-item label="Camera:">
          <div id="cam_opt" >
            <el-select v-model="formVideo.videoFormat.src_id" @change="onChangeSrcID" :disabled="setting_sns_count == 1" size="mini">
        ...
        <el-form-item label="Main Stream0" class="inline" v-show="formVideo.cap_list[0] > 0">
        ...
        <el-form-item label="" label-width="50px" v-show="formVideo.cap_list[0] > 0 && formVideo.videoFormat.video0.enable_stream" >
          <el-form-item label="Encode Type:" class="inline">
            ...
            <el-form-item label="Bitrate(kbps):" class="inline">
            <el-input-number controls-position="right" :min="500" :max="15000" :step="500" v-model="formVideo.videoFormat.video0.bit_rate" style="width:91%" :disabled="!formVideo.videoFormat.video0.enable_stream" size="mini"></el-input-number>
          </el-form-item>
          <el-row>
            <el-form-item label="Resolution:" class="inline">
            ...
            <el-form-item label="RC:" class="inline">
          ...
          <el-row>
            ...
            <el-form-item label="min_i_prop:" class="inline" v-show="formVideo.videoFormat.video0.rc_type === 0 && formVideo.videoFormat.video0.encoder_type != 1">
            ...
            <el-form-item label="max_i_prop:" class="inline" v-show="formVideo.videoFormat.video0.rc_type === 0 && formVideo.videoFormat.video0.encoder_type != 1">
        ...
        <el-row>
          <el-form-item label="Sub Stream1" class="inline" v-show="formVideo.cap_list[1] > 0">
        ...
        <el-form-item label="" label-width="50px" v-show="formVideo.cap_list[1] > 0 && formVideo.videoFormat.video1.enable_stream">
          <el-form-item label="Encode Type:" class="inline">
            <div id="rc_encoder_type_1">
              <el-select v-model="formVideo.videoFormat.video1.encoder_type" style="width:91%" @change="onChangeEncRcType(0)" size="mini">
          ...
          <el-form-item label="Bitrate(kbps):" class="inline">
            <el-input-number controls-position="right" :min="500" :max="15000" :step="500" v-model="formVideo.videoFormat.video1.bit_rate" style="width:91%" :disabled="!formVideo.videoFormat.video1.enable_stream" size="mini"></el-input-number>
          </el-form-item>
          <el-row>
          <el-form-item label="Resolution:" class="inline">
          ...
          <el-row>
            ...
            <el-form-item label="min_i_prop:" class="inline" v-show="formVideo.videoFormat.video1.rc_type === 0 && formVideo.videoFormat.video1.encoder_type != 1">
            ...
            <el-form-item label="max_i_prop:" class="inline" v-show="formVideo.videoFormat.video1.rc_type === 0 && formVideo.videoFormat.video1.encoder_type != 1">
        ...
        <el-row>
          <el-form-item label="Sub Stream2" class="inline" v-show="formVideo.cap_list[2] > 0">
        ...
        <el-form-item label="" label-width="50px" v-show="formVideo.cap_list[2] > 0 && formVideo.videoFormat.video2.enable_stream">
          <el-form-item label="Encode Type:" class="inline">
            <div id="rc_encoder_type_2">
              <el-select v-model="formVideo.videoFormat.video2.encoder_type" style="width:91%" @change="onChangeEncRcType(0)" size="mini">
          ...
          <el-form-item label="Bitrate(kbps):" class="inline">
            <el-input-number controls-position="right" :min="500" :max="15000" :step="500" v-model="formVideo.videoFormat.video2.bit_rate" style="width:91%" :disabled="!formVideo.videoFormat.video2.enable_stream" size="mini"></el-input-number>
          </el-form-item>
          <el-row>
            <el-form-item label="Resolution:" class="inline">
          ...
          <el-row>
            ...
            <el-form-item label="min_i_prop:" class="inline" v-show="formVideo.videoFormat.video2.rc_type === 0 && formVideo.videoFormat.video2.encoder_type != 1">
            ...
            <el-form-item label="max_i_prop:" class="inline" v-show="formVideo.videoFormat.video2.rc_type === 0 && formVideo.videoFormat.video2.encoder_type != 1">
        ...
        <el-row>
          <el-form-item label="Sub Stream3" class="inline" v-show="formVideo.cap_list[3] > 0">
        ...
        <el-form-item label="" label-width="50px" v-show="formVideo.cap_list[3] > 0 && formVideo.videoFormat.video3.enable_stream">
          <el-form-item label="Encode Type:" class="inline">
            <div id="rc_encoder_type_3">
              <el-select v-model="formVideo.videoFormat.video3.encoder_type" style="width:91%" size="mini">
          ...
          <el-form-item label="Bitrate(kbps):" class="inline">
            <el-input-number controls-position="right" :min="500" :max="15000" :step="500" v-model="formVideo.videoFormat.video3.bit_rate" style="width:91%" :disabled="!formVideo.videoFormat.video3.enable_stream" size="mini"></el-input-number>
          </el-form-item>
          <el-row>
            <el-form-item label="Resolution:" class="inline">
            ...
            <el-form-item label="RC:" class="inline">
              <div id="rc_type_opt_3" >
                <el-select v-model="formVideo.videoFormat.video3.rc_type" style="width:91%" :disabled="false" size="mini">
            ...
            <el-form-item label="min_qp:" class="inline" v-show="formVideo.videoFormat.video3.rc_type === 0 && formVideo.videoFormat.video3.encoder_type != 1">
              <div id="rc_min_qp_3">
            ...
            <el-form-item label="max_qp:" class="inline" v-show="formVideo.videoFormat.video3.rc_type === 0 && formVideo.videoFormat.video3.encoder_type != 1">
              <div id="rc_max_qp_3">
                <el-input-number controls-position="right" :min=formVideo.videoFormat.video3.min_qp :max="100" :step="10" v-model="formVideo.videoFormat.video3.max_qp" style="width:91%" :disabled="false" @change="onChangeRcVal(3)" size="mini"></el-input-number>
              </div>
            </el-form-item>
          <el-row>
            <el-form-item label="min_iqp:" class="inline" v-show="formVideo.videoFormat.video3.rc_type === 0 && formVideo.videoFormat.video3.encoder_type != 1">
              <div id="rc_min_iqp_3">
            ...
            <el-form-item label="max_iqp:" class="inline" v-show="formVideo.videoFormat.video3.rc_type === 0 && formVideo.videoFormat.video3.encoder_type != 1">
              <div id="rc_max_iqp_3">
                <el-input-number controls-position="right" :min=formVideo.videoFormat.video3.min_iqp :max="100" :step="10" v-model="formVideo.videoFormat.video3.max_iqp" style="width:91%" :disabled="false" @change="onChangeRcVal(3)" size="mini"></el-input-number>
              </div>
            </el-form-item>
          </el-row>
            <el-form-item label="min_i_prop:" class="inline" v-show="formVideo.videoFormat.video3.rc_type === 0 && formVideo.videoFormat.video3.encoder_type != 1">
            ...
            <el-form-item label="max_i_prop:" class="inline" v-show="formVideo.videoFormat.video3.rc_type === 0 && formVideo.videoFormat.video3.encoder_type != 1">
...
export default {
  ...
  methods: {
    ...
    init_resolution_options() {
      var _video_info_array = this.formVideo.enc_rc_info
      try {
    ...
    onChangeEncRcType(channel) {
      let _video_info_array = [this.formVideo.videoFormat.video0
        , this.formVideo.videoFormat.video1
        , this.formVideo.videoFormat.video2
        , this.formVideo.videoFormat.video3]

      {
        for (let j = 0; j < this.formVideo.enc_rc_info[channel].enc_rc_info.length; j++) {
          let rc_info = this.formVideo.enc_rc_info[channel].enc_rc_info[j]
