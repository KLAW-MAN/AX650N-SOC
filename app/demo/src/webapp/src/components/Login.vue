    ...
    <div class="login_box">
      ...
      <el-form class="login_form" ref="loginFormRef" :rules="loginFormRules" :model="loginForm" label-width="0px">
        <el-form-item prop="username">
          <el-input v-model="loginForm.username" prefix-icon="el-icon-s-custom" placeholder="Please input username"></el-input>
        </el-form-item>
        <el-form-item prop="password">
          <el-input type="password" v-model="loginForm.password" prefix-icon="el-icon-lock" placeholder="Please input password"></el-input>
        </el-form-item>
        <el-form-item>
          <el-checkbox v-model="keepuser" label="Remember Username"></el-checkbox>
        </el-form-item>
        <el-form-item>
          <el-button class="login-button" type="primary" @click="doLogin">Login</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
  ...
  methods: {
    doLogin () {
      this.$refs.loginFormRef.validate(async valid => {
        ...
        window.sessionStorage.setItem('snsSelect', res.data.snsSelect)
