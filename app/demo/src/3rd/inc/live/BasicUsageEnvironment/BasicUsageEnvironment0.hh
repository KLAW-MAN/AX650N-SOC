...
public:
  ...
  static void DestoryDelayedTaskWarpper(void *mem, void *arg);
  void DestoryDelayedTask(void *mem);
...
protected:
  ...
  BasicPool *fAlarmHandlerPool;
};

inline int BasicTaskScheduler0::GetDelayedTaskCount() {
  return fDelayQueue.GetEntryCount();
}
