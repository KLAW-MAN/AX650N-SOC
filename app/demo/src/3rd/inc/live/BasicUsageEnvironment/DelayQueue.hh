...
///// DelayQueueEntry /////
typedef void (*DestoryFunc)(void *mem, void *arg);
struct EntryDestory {
  DestoryFunc destory;
  void *arg;
};
...
public:
  ...
  void setDestory(struct EntryDestory destory) {
    fDestory = destory;
  }
...
private:
  ...
  int fEntryCount; /* number of entries */
};

inline int DelayQueue::GetEntryCount() {
  return fEntryCount;
}
