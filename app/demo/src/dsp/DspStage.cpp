...
AX_BOOL CDspStage::Init() {
    ...
    do {
        if (!CDspUtils::InitDsp((AX_DSP_ID_E)m_tDspAttr.nDspId, m_tDspAttr.strSramPath.data(), m_tDspAttr.strItcmPath.data())) {
            break;
        }
...
AX_BOOL CDspStage::DeInit() {
    ...
    CDspUtils::DeInitDsp((AX_DSP_ID_E)m_tDspAttr.nDspId);
