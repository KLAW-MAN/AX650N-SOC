...
protected:
    ...
    AX_BOOL InitDisplay(AX_DISPDEV_TYPE enDispDev, DISPVO_CONFIG_T& dispVoConfig, AX_U32 nChnCount);
    ...
    AX_BOOL InitFrameBuffer(AX_U32 width, AX_U32 height, AX_U8 fb);
