...
typedef struct {
    AX_U32 nMaxGrp;
} AICARD_SLV_SYS_ATTR_T;

class CAiCardSlvAppSys {
public:
    CAiCardSlvAppSys(AX_VOID) = default;
    virtual ~CAiCardSlvAppSys(AX_VOID) = default;

    AX_BOOL Init(const AICARD_SLV_SYS_ATTR_T& stAttr, const std::string& strAppName = "AiCardSlv");
...
private:
    ...
    AICARD_SLV_SYS_ATTR_T m_strAttr;
