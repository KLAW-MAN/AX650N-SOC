...
public:
    ...
    AX_BOOL RegisterAiSwitchStateChangeObs(CAiSwitchStateObs* pObs);
    AX_BOOL UnregisterAiSwitchStateChangeObs(CAiSwitchStateObs* pObs);
...
protected:
    ...
    AX_VOID NotifyStateObservers(AX_U32 nState);
...
protected:
    ...
    std::vector<CAiSwitchStateObs*> m_vecStateChangeObs;
