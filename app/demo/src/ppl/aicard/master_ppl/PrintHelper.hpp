...
// typedef struct _TRANS_RECV_PRINT_INFO_T
// {
//     AX_U32 nFSTargetFPS[MAX_CHANNEL_NUM];
//     AX_U32 nFSReceivedPackets[MAX_CHANNEL_NUM];
//     AX_U32 nFSPeriodPackets[MAX_CHANNEL_NUM];
//     AX_CHAR szName[64];

//     _TRANS_RECV_PRINT_INFO_T(const AX_CHAR* szModName) {
//         memset(this, 0, sizeof(_TRANS_RECV_PRINT_INFO_T));
//         strcpy(szName, szModName);
//     }

//     AX_VOID Init(AX_U32 nChn, AX_U32 nTargetFPS) {
//         nFSTargetFPS[nChn] = nTargetFPS;
//     }
...
//         nFSPeriodPackets[nChn]++;
//         nFSReceivedPackets[nChn]++;
//     }
...
//     AX_VOID Print() {
//         for (AX_U32 i = 0; i < MAX_CHANNEL_NUM; i++) {
//             if (nFSPeriodPackets[i] > 0) {
//                 LOG_M_C(szName, "[%d] fps %5.2f, recv %d",
//                     i,
//                     nFSPeriodPackets[i] * 1.0 / PRINT_INTERVAL,
//                     nFSReceivedPackets[i]);

//                 nFSPeriodPackets[i] = 0;
//             }
//         }
//     }

// } TRANS_RECV_PRINT_INFO_T;
...
private:
    ...
    PCIE_PRINT_INFO_T m_tTransRecv {"TRANS_RECV"};
    PCIE_PRINT_INFO_T m_tTransSend {"TRANS_SEND"};
};
