...
typedef struct VO_ATTR_S {
    ...
    AX_S32 nGraphicLayerVFresh;       /* [IN ] graphic layer vfresh fps */
    ...
    VO_ATTR_S(AX_VOID) {
        ...
        enMaxIntfSync = AX_VO_OUTPUT_BUTT;
        enIntfFmt = AX_VO_OUT_FMT_UNUSED;
        bForceDisplay = AX_TRUE;
        enEngineMode = AX_VO_ENGINE_MODE_AUTO;
        nEngineId = 0;
        nBgClr = 0x000000; /* black */
        nLayerDepth = 3;
        nGraphicLayerVFresh = -1;
...
public:
    ...
    AX_BOOL GetVideoLayerCSC(AX_VO_CSC_T& csc);
    AX_BOOL SetVideoLayerCSC(CONST AX_VO_CSC_T& csc);
