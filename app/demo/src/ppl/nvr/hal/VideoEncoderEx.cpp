...
AX_BOOL CVideoEncoderEx::Init() {
    ...
    if (m_tVideoConfig.nGdrNum > 0 && m_tVideoConfig.nGdrNum < m_tVideoConfig.nGOP) {
        if (!ActiveGDR(m_tVideoConfig.nGdrNum)) {
            return AX_FALSE;
        }
    }
    ...
    switch (m_tVideoConfig.ePayloadType) {
        case PT_H264: {
            ...
            if (AX_TRUE == tRcConfig.GetRcInfo(eRcType, rcInfo)) {
                ...
                m_tVencRcParams.tH264Cbr.u32BitRate = rcInfo.nBitrate;
            ...
            if (AX_TRUE == tRcConfig.GetRcInfo(eRcType, rcInfo)) {
                ...
                m_tVencRcParams.tH264Vbr.u32MaxBitRate = rcInfo.nBitrate;
        ...
        case PT_H265: {
            ...
            if (AX_TRUE == tRcConfig.GetRcInfo(eRcType, rcInfo)) {
                ...
                m_tVencRcParams.tH265Cbr.u32BitRate = rcInfo.nBitrate;
            ...
            if (AX_TRUE == tRcConfig.GetRcInfo(eRcType, rcInfo)) {
                ...
                m_tVencRcParams.tH265Vbr.u32MaxBitRate = rcInfo.nBitrate;
