...
int main(int argc, char *argv[]) {
    /* ============================================ SAMPLE COMMAND ============================================ */
    /*  Load all .ind files in the "datastream" directory and traverse frames */
    /* ./ut_datastream_search -p "/opt/data/datastream" -t 0 */

    /* Load the data file "/opt/data/datastream/DEV_01/1970-01-01/main_13-53-59.dat" and traverse frames */
    /* ./ut_datastream_search -p "/opt/data/datastream/DEV_01/1970-01-01/main_13-53-59.dat" -t 1 */

    /* Load the index file "/opt/data/datastream/DEV_01/1970-01-01/main.ind" and traverse file info */
    /* ./ut_datastream_search -p "/opt/data/datastream/DEV_01/1970-01-01/main.ind" -t 2 */

    /* Load the index file for Device_0 and Stream_0 in the "datastream/1970-01-01" directory, and start traversing from 10:10:10 */
    /* ./ut_datastream_search -p "/opt/data/datastream" -d 0 -s 0 -e 19700101 -m 101010 -t 3 */

    /* Search for all device date subdirectories in the "/opt/data/datastream" directory */
    /* ./ut_datastream_search -p "/opt/data/datastream" -t 4 */

    /* Search for frame time range information of all devices on a specified date in the "/opt/data/datastream" directory */
    ...
    switch (eType) {
        ...
        case CASE_TYPE_SEARCH_IND_DAT: {
            ...
            do {
                ...
                instance->StartPlay(nDevice, nStream, nDate, nTime, 0, bReverse);
