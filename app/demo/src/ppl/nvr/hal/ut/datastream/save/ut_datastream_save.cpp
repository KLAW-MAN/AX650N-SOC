...
int main(int argc, char *argv[]) {
    /* Start 2 devices, each with 2 streams (main, sub1).
       Use --rtsp1 to specify the input source for device 1, and --rtsp2 to specify the input source for device 2.
       Streams of the same device share the same input source. Split the file every 1 minute. */
