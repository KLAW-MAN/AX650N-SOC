...
const vector<AX_NVR_RECT_T> SplitWidgetMgr::CalcLayouts(SPLIT_TYPE enSplitType,
    ...
    int rect_w_tmp = (nWidth - (cols_ - 1) * horizontalSpacing) / cols_ - nLeftMargin - nRightMargin;
    int rect_h_tmp = (nHeight - (rows_ - 1) * verticalSpacing) / rows_ - nTopMargin - nBottomMargin;
