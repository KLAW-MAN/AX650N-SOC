...
namespace AX_PANO {
#define MAX_COLLECT_GROUP_NUM (8)
...
typedef struct COLLECTOR_ATTR_S {
    ...
    AX_U32 nCfgWidth{APP_COLLECT_INVALID};
    AX_U32 nCfgHeight{APP_COLLECT_INVALID};
    AX_S8  nSnsSrc{APP_COLLECT_INVALID};
    AX_F32 fFramerate{APP_COLLECT_INVALID};
    AX_U8  arrFBC[2]{0};  /* 2: [mode, level] */
} COLLECTOR_ATTR_T;
...
public:
    ...
    AX_BOOL ChangeData(OBS_CHANGE_DATA_TYPE_E eDataType, AX_VOID* pData);
