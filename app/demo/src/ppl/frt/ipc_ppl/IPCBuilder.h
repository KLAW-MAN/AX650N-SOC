...
private:
    ...
    AX_BOOL ChangePanoDayNightMode(AX_DAYNIGHT_MODE_E eDayNightMode);

    AX_BOOL UpdateVinRotation(AX_U8 nSnsID, AX_U8 nRotation);
    AX_BOOL UpdateIvpsRotation(AX_U8 nSnsID, AX_U8 nRotation);
    AX_BOOL UpdateRotation(AX_U8 nSnsID, AX_U8 nRotation);
    AX_BOOL ChangeVinMirrorFlip(AX_U8 nSnsID, AX_BOOL bMirror, AX_BOOL bFlip);
    AX_BOOL ChangeIvpsMirrorFlip(AX_U8 nSnsID, AX_BOOL bMirror, AX_BOOL bFlip);
    AX_BOOL ChangeMirrorFlip(AX_U8 nSnsID, AX_BOOL bMirror, AX_BOOL bFlip);
...
private:
    ...
    AX_U8  m_nPreRotation{0};
    std::vector<std::string> vecPreMainResolutions;
};
}  // namespace AX_IPC