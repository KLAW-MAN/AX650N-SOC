...
typedef enum
{
	OSD_DATE_FORMAT_YYMMDD1,				/* XXXX-XX-XX (YMD) */
	OSD_DATE_FORMAT_MMDDYY1,				/* XX-XX-XXXX (MDY) */
	OSD_DATE_FORMAT_DDMMYY1,				/* XX-XX-XXXX (DMY) */
	OSD_DATE_FORMAT_YYMMDD2,				/* XXXXYXXMXXD */
	OSD_DATE_FORMAT_MMDDYY2,				/* XXMXXDXXXXY */
	OSD_DATE_FORMAT_DDMMYY2,				/* XXDXXMXXXXY */
	OSD_DATE_FORMAT_YYMMDD3,				/* XXXX/XX/XX (YMD) */
	OSD_DATE_FORMAT_MMDDYY3,				/* XXXX/XX/XX (MDY) */
	OSD_DATE_FORMAT_DDMMYY3,				/* XXXX/XX/XX (DMY) */
	OSD_DATE_FORMAT_YYMMDDWW1,				/* XXXX-XX-XX XXX (YMD Week) */
    OSD_DATE_FORMAT_HHmmSS,				    /* XX:XX:XX (HmS) */
	OSD_DATE_FORMAT_YYMMDDHHmmSS,			/* XXXX-XX-XX XX:XX:XX (YMD HmS) */
    OSD_DATE_FORMAT_YYMMDDHHmmSSWW,			/* XXXX-XX-XX XX:XX:XX XXX (YMD HmS Week) */
