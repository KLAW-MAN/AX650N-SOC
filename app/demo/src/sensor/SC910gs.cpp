...
AX_VOID CSC910gs::InitMipiRxAttr() {
    ...
    m_tMipiRxDev.tLvdsAttr.nDataRate = 750;
    ...
    m_tMipiRxDev.tLvdsAttr.nClkLane[1] = 0x00;
}
...
AX_VOID CSC910gs::InitDevAttr() {
    ...
    m_tDevAttr.tLvdsIntfAttr.szSyncCode[1][0][0] = 0xab00;
    m_tDevAttr.tLvdsIntfAttr.szSyncCode[1][0][1] = 0x8000;
    m_tDevAttr.tLvdsIntfAttr.szSyncCode[2][0][0] = 0xab00;
    m_tDevAttr.tLvdsIntfAttr.szSyncCode[2][0][1] = 0x8000;
    m_tDevAttr.tLvdsIntfAttr.szSyncCode[3][0][0] = 0xab00;
    m_tDevAttr.tLvdsIntfAttr.szSyncCode[3][0][1] = 0x8000;
...
AX_VOID CSC910gs::InitTriggerAttr() {
    ...
    m_tSnapAttr.tVsyncAttr = {0, AX_VIN_SYNC_POLARITY_HIGH, 2700, 1};
    m_tSnapAttr.tHsyncAttr = {0, AX_VIN_SYNC_POLARITY_HIGH, 7407, 1};

    m_tSnapAttr.tLightSyncAttr.nVts = 2700;
    m_tSnapAttr.tLightSyncAttr.nHts = 7407;
    ...
    m_tSnapAttr.tStrobeAttr = {AX_VIN_SYNC_POLARITY_LOW, 200, 100, 2};
