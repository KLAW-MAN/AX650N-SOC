...
COS04a102Lane::COS04a102Lane(SENSOR_CONFIG_T tSensorConfig) : CBaseSensor(tSensorConfig) {
}

COS04a102Lane::~COS04a102Lane(AX_VOID) {
}

AX_VOID COS04a102Lane::InitSnsLibraryInfo(AX_VOID) {
    m_tSnsLibInfo.strObjName = "gSnsos04a10Obj";
    m_tSnsLibInfo.strLibName = "libsns_os04a10.so";
}

AX_VOID COS04a102Lane::InitSnsAttr() {
...
AX_VOID COS04a102Lane::InitDevAttr() {
...
AX_VOID COS04a102Lane::InitPrivAttr() {
...
AX_VOID COS04a102Lane::InitPipeAttr() {
...
AX_VOID COS04a102Lane::InitChnAttr() {
...
AX_VOID COS04a102Lane::InitAbilities() {
    m_tAbilities.bSupportHDR = AX_TRUE;
    m_tAbilities.bSupportHDRSplit = AX_TRUE;
}

AX_VOID COS04a102Lane::InitTriggerAttr() {
