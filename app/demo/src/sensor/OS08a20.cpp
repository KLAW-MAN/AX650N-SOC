...
#define SENSOR "OS08A20"


COS08a20::COS08a20(SENSOR_CONFIG_T tSensorConfig) : CBaseSensor(tSensorConfig) {
...
AX_SNS_HDR_MODE_E COS08a20::GetMaxHdrMode() {
...
AX_VOID COS08a20::InitSnsLibraryInfo(AX_VOID) {
    m_tSnsLibInfo.strLibName = "libsns_os08a20.so";
    m_tSnsLibInfo.strObjName = "gSnsos08a20Obj";
}
...
AX_VOID COS08a20::InitSnsAttr() {
    ...
    if (50 == m_tSnsAttr.fFrameRate || 60 == m_tSnsAttr.fFrameRate) {
...
AX_VOID COS08a20::InitSnsClkAttr() {
