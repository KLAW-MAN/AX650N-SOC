...
CSC450AI2Lane::CSC450AI2Lane(SENSOR_CONFIG_T tSensorConfig) : CBaseSensor(tSensorConfig) {
}

CSC450AI2Lane::~CSC450AI2Lane(AX_VOID) {
}

AX_VOID CSC450AI2Lane::InitSnsLibraryInfo(AX_VOID) {
    m_tSnsLibInfo.strObjName = "gSnssc450aiObj";
    m_tSnsLibInfo.strLibName = "libsns_sc450ai.so";
}

AX_VOID CSC450AI2Lane::InitSnsAttr() {
    ...
    m_tSnsAttr.eMasterSlaveSel = m_tSnsCfg.eMasterSlaveSel;
    m_tSnsAttr.eSnsOutputMode = m_tSnsCfg.eSnsOutputMode;
}

AX_VOID CSC450AI2Lane::InitSnsClkAttr() {
    /* Referenced by AX_VIN_OpenSnsClk */
    m_tSnsClkAttr.nSnsClkIdx = m_tSnsCfg.nClkID;
    m_tSnsClkAttr.eSnsClkRate = AX_SNS_CLK_24M;
}

AX_VOID CSC450AI2Lane::InitMipiRxAttr() {
    ...
    m_tMipiRxDev.tMipiAttr.eLaneNum = AX_MIPI_DATA_LANE_2;
    m_tMipiRxDev.tMipiAttr.nDataRate = 720;
    m_tMipiRxDev.tMipiAttr.nDataLaneMap[0] = 0x00;
    m_tMipiRxDev.tMipiAttr.nDataLaneMap[1] = 0x01;
    m_tMipiRxDev.tMipiAttr.nDataLaneMap[2] = -1;
    m_tMipiRxDev.tMipiAttr.nDataLaneMap[3] = -1;
...
AX_VOID CSC450AI2Lane::InitDevAttr() {
...
AX_VOID CSC450AI2Lane::InitPrivAttr() {
...
AX_VOID CSC450AI2Lane::InitPipeAttr() {
...
AX_VOID CSC450AI2Lane::InitChnAttr() {
...
AX_VOID CSC450AI2Lane::InitAbilities() {
    m_tAbilities.bSupportHDR = AX_TRUE;
    m_tAbilities.bSupportHDRSplit = AX_TRUE;
}

AX_VOID CSC450AI2Lane::InitTriggerAttr() {
