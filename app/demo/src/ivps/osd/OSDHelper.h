...
public:
    ...
    AX_BOOL Refresh(AX_BOOL bShow = AX_TRUE) override;
    ...
    AX_BOOL SetOsdConfig(AX_U8 nSnsID, AX_S32 nGrp, AX_S32 nChn, AX_BOOL bVideo, const OSD_SHOW_FLAG_T stOsdShowFlag, AX_S16 nLinkedVId = -1) override;
    AX_BOOL SetPrivacyConfig(AX_U8 nSnsID, AX_S32 nGrp) override;
...
private:
    ...
    AX_S32 GetRgnFilter(AX_U8 nIvpsFilterCfg, AX_U8 nIvpsChn = 0);
    AX_BOOL GetPrivacyPoint(AX_U32 nGrpWidth, AX_U32 nGrpHeight, AX_U32 nBaseWidth, AX_U32 nBaseHeight, OSD_POINT_T* pOsdPoint);
    AX_BOOL GetSrcResolution(AX_U32 nChn, AX_U32& nWidth, AX_U32& nHeight);
